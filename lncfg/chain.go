...
type Chain struct {
	...
	MinHTLCIn           lnwire.MilliLoki `long:"minhtlc" description:"The smallest HTLC we are willing to accept on our channels, in MilliLoki"`
	MinHTLCOut          lnwire.MilliLoki `long:"minhtlcout" description:"The smallest HTLC we are willing to send out on our channels, in MilliLoki"`
	BaseFee             lnwire.MilliLoki `long:"basefee" description:"The base fee in MilliLoki we will charge for forwarding payments on our channels"`
