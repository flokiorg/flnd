...
var (
	...
	addressTestVectors = []addressTest{
		{"tcp://127.0.0.1:5521", "tcp", "127.0.0.1:5521", true, false},
		{"tcp:127.0.0.1:5521", "tcp", "127.0.0.1:5521", true, false},
		{"127.0.0.1:5521", "tcp", "127.0.0.1:5521", true, false},
		{":5521", "tcp", ":5521", false, false},
		{"", "tcp", ":1234", false, false},
		{":", "tcp", ":1234", false, false},
		{"tcp4://127.0.0.1:5521", "tcp", "127.0.0.1:5521", true, false},
		{"tcp4:127.0.0.1:5521", "tcp", "127.0.0.1:5521", true, false},
		...
		{"tcp6:::1", "tcp", "[::1]:1234", true, false},
		{"localhost:5521", "tcp", "127.0.0.1:5521", true, false},
		...
		{
			"4acth47i6kxnvkewtm6q7ib2s3ufpo5sqbsnzjpbi7utijcltosqemad.onion:5521",
			"tcp",
			"4acth47i6kxnvkewtm6q7ib2s3ufpo5sqbsnzjpbi7utijcltosqemad.onion:5521",
			false,
			false,
...
var (
	...
	pubKey, _ = crypto.ParsePubKey(pubKeyBytes)
)

type lnAddressCase struct {
	lnAddress      string
	expectedPubKey *crypto.PublicKey
