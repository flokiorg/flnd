...
import (
	...
	"github.com/flokiorg/flnd/kvdb/postgres"
...
func (db *DB) GetBackends(ctx context.Context, chanDBPath,
	...
	towerServerEnabled bool, logger flog.Logger) (*DatabaseBackends,
	error) {
...
func warnExistingBoltDBs(log flog.Logger, dbType, dir, fileName string) {
