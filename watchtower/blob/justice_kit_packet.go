...
func toBlobSchnorrPubKey(pubKey *crypto.PublicKey) schnorrPubKey {
...
func toBlobPubKey(pk *crypto.PublicKey) pubKey {
...
func (b *justiceKitPacketV0) decode(r io.Reader) error {
	...
	if crypto.IsCompressedPubKey(commitToRemotePubkey[:]) {
