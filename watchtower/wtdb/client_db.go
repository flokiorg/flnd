...
func (c *ClientDB) RemoveTower(pubKey *crypto.PublicKey, addr net.Addr) error {
...
func (c *ClientDB) DeactivateTower(pubKey *crypto.PublicKey) error {
	return kvdb.Update(c.db, func(tx kvdb.RwTx) error {
		towers := tx.ReadWriteBucket(cTowerBkt)
		if towers == nil {
			return ErrUninitializedDB
...
func (c *ClientDB) LoadTower(pubKey *crypto.PublicKey) (*Tower, error) {
	var tower *Tower
	err := kvdb.View(c.db, func(tx kvdb.RTx) error {
		towers := tx.ReadBucket(cTowerBkt)
		if towers == nil {
