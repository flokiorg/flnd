...
func (h *clientDBHarness) deactivateTower(pubKey *crypto.PublicKey,
	expErr error) {
...
func (h *clientDBHarness) removeTower(pubKey *crypto.PublicKey, addr net.Addr,
...
func (h *clientDBHarness) loadTower(pubKey *crypto.PublicKey,
	expErr error) *wtdb.Tower {
