...
type ClientManager interface {
	...
	// instead.
	RemoveTower(*crypto.PublicKey, net.Addr) error
	...
	DeactivateTower(pubKey *crypto.PublicKey) error
	...
	LookupTower(*crypto.PublicKey, ...wtdb.ClientSessionListOption) (
		map[blob.Type]*RegisteredTower, error)
...
func (m *Manager) RemoveTower(key *crypto.PublicKey, addr net.Addr) error {
...
func (m *Manager) DeactivateTower(key *crypto.PublicKey) error {
...
// LookupTower retrieves a registered watchtower through its public key.
func (m *Manager) LookupTower(key *crypto.PublicKey,
