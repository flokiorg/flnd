...
func (m *MockChain) Rescan(startHash *chainhash.Hash, addrs []chainutil.Address,
...
func (m *MockChain) NotifyReceived(addrs []chainutil.Address) error {
	args := m.Called(addrs)
...
func (m *MockChain) TestMempoolAccept(txns []*wire.MsgTx, maxFeeRate float64) (
	...
	return args.Get(0).([]*chainjson.TestMempoolAcceptResult), args.Error(1)
}
