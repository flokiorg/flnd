...
import (
	...
	f1log "github.com/flokiorg/go-flokicoin/log"
...
func AddV1SubLogger(root *build.SubLoggerManager, subsystem string,
	interceptor signal.Interceptor, useLoggers ...func(f1log.Logger)) {
...
// sub system. Note that the flog v2 logger implements the flog v1 logger
...
func SetV1SubLogger(root *build.SubLoggerManager, subsystem string,
	logger flog.Logger, useLoggers ...func(f1log.Logger)) {
