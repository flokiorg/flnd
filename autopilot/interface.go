...
type LocalChannel struct {
	...
	// Balance is the local balance of the channel expressed in loki.
...
type ChannelEdge struct {
	...
	// Capacity is the capacity of the channel expressed in loki.
...
type ChannelController interface {
	...
	OpenChannel(target *crypto.PublicKey, amt chainutil.Amount) error
