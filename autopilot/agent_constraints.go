...
type AgentConstraints interface {
	...
	ChannelBudget(chans []LocalChannel, balance chainutil.Amount) (
		chainutil.Amount, uint32)
...
func NewConstraints(minChanSize, maxChanSize chainutil.Amount, chanLimit,
...
func (h *agentConstraints) ChannelBudget(channels []LocalChannel,
	funds chainutil.Amount) (chainutil.Amount, uint32) {
	...
	var totalChanAllocation chainutil.Amount
	...
	targetAllocation := chainutil.Amount(float64(totalFunds) * h.allocation)
...
//
// Note: part of the AgentConstraints interface.
func (h *agentConstraints) MinChanSize() chainutil.Amount {
...
//
// Note: part of the AgentConstraints interface.
func (h *agentConstraints) MaxChanSize() chainutil.Amount {
