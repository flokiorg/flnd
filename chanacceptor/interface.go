...
func NewChannelAcceptResponse(accept bool, acceptErr error,
	...
	minDepth uint16, reserve chainutil.Amount, inFlight,
	minHtlcIn lnwire.MilliLoki, zeroConf bool) *ChannelAcceptResponse {
