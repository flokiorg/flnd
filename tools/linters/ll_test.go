...
func TestGetLLLIssuesForFile(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			logRegex: defaultLogRegex,
			content:  `import "github.com/flokiorg/flnd/lnrpc/walletrpc/more/more/more/more/more/more/ok/that/is/enough"`,
		},
		{
			...
			import (
				"os"
				"fmt"
				"github.com/flokiorg/flnd/lnrpc/walletrpc/more/ok/that/is/enough"
			)`,
		},
		{
