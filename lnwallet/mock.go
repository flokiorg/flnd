...
func (w *mockWalletController) ConfirmedBalance(int32, string) (chainutil.Amount,
	error) {
...
func (w *mockWalletController) NewAddress(AddressType, bool,
	...
	addr, _ := chainutil.NewAddressPubKey(
...
func (w *mockWalletController) IsOurAddress(chainutil.Address) bool {
	return false
}
...
func (w *mockWalletController) RequiredReserve(uint32) chainutil.Amount {
	return 0
}
...
func (w *mockWalletController) ImportPublicKey(*crypto.PublicKey,
