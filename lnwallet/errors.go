...
func ErrChanReserveTooSmall(reserve, dustLimit chainutil.Amount) ReservationError {
	return ReservationError{
...
func ErrChanReserveTooLarge(reserve,
	maxReserve chainutil.Amount) ReservationError {
	return ReservationError{
...
func ErrMinHtlcTooLarge(minHtlc,
	maxMinHtlc lnwire.MilliLoki) ReservationError {
	return ReservationError{
...
func ErrMaxValueInFlightTooSmall(maxValInFlight,
	minMaxValInFlight lnwire.MilliLoki) ReservationError {
	return ReservationError{
...
func ErrChanTooSmall(chanSize, minChanSize chainutil.Amount) ReservationError {
	return ReservationError{
...
func ErrChanTooLarge(chanSize, maxChanSize chainutil.Amount) ReservationError {
	return ReservationError{
...
// was rejected.
func ErrInvalidDustLimit(dustLimit chainutil.Amount) ReservationError {
	return ReservationError{
