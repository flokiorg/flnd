...
func NewShimIntent(localAmt, remoteAmt chainutil.Amount,
	localKey *keychain.KeyDescriptor, remoteKey *crypto.PublicKey,
...
func (s *ShimIntent) TaprootInternalKey() fn.Option[*crypto.PublicKey] {
	if !s.musig2 {
		return fn.None[*crypto.PublicKey]()
	}
	...
	combinedKey, _, _, _ := musig2.AggregateKeys(
		[]*crypto.PublicKey{s.localKey.PubKey, s.remoteKey}, true,
	)
...
//
// NOTE: This method satisfies the chanfunding.Intent interface.
func (s *ShimIntent) LocalFundingAmt() chainutil.Amount {
...
//
// NOTE: This method satisfies the chanfunding.Intent interface.
func (s *ShimIntent) RemoteFundingAmt() chainutil.Amount {
...
func NewCannedAssembler(thawHeight uint32, chanPoint wire.OutPoint,
	fundingAmt chainutil.Amount, localKey *keychain.KeyDescriptor,
	remoteKey *crypto.PublicKey, initiator, musig2 bool) *CannedAssembler {
