...
type testCase struct {
	...
	DustLimitLokis chainutil.Amount
...
func testVectors(t *testing.T, chanType channeldb.ChannelType, test testCase) {
	...
	// default.
	if test.DustLimitLokis != 0 {
		tc.dustLimit = test.DustLimitLokis
	}
	...
	// capacity.
	require.EqualValues(t, lnwire.NewMSatFromLokis(tc.fundingAmount),
...
func testSpendValidation(t *testing.T, tweakless bool) {
	...
	// Each side currently has 1 FLC within the channel, with a total
