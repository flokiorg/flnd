...
import (
	...
	basewallet "github.com/flokiorg/walletd/wallet"
...
func (r *RPCKeyRing) ECDH(keyDesc keychain.KeyDescriptor,
	pubKey *crypto.PublicKey) ([32]byte, error) {
...
func (r *RPCKeyRing) DerivePrivKey(_ keychain.KeyDescriptor) (*crypto.PrivateKey,
	error) {
...
func (r *RPCKeyRing) MuSig2CreateSession(bipVersion input.MuSig2Version,
	keyLoc keychain.KeyLocator, pubKeys []*crypto.PublicKey,
...
func (r *RPCKeyRing) remoteSign(tx *wire.MsgTx, signDesc *input.SignDescriptor,
	...
	case signDesc.KeyDesc.PubKey != nil && signDesc.KeyDesc.IsEmpty():
		...
		addr, err := chainutil.NewAddressWitnessPubKeyHash(
			chainutil.Hash160(pubKeyBytes), r.netParams,
		)
		if err != nil {
	...
	case input.TaprootScriptSpendSignMethod:
		...
		// that we don't have.
		fakeInternalKey, _ := crypto.ParsePubKey(d.PubKey)
