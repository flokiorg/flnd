...
func NewMusigPartialSig(sig *musig2.PartialSignature, signerNonce,
	combinedNonce lnwire.Musig2Nonce, signerKeys []*crypto.PublicKey,
...
func (p *MusigPartialSig) Verify(msg []byte, pub *crypto.PublicKey) bool {
	var m [32]byte
	copy(m[:], msg)
...
func NewPartialMusigSession(verificationNonce musig2.Nonces,
	...
	signerKeys := []*crypto.PublicKey{localKey.PubKey, remoteKey.PubKey}
