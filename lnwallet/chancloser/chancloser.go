...
type DeliveryAddrWithKey struct {
	...
	InternalKey fn.Option[crypto.PublicKey]
}
...
type ChanCloser struct {
	...
	lastFeeProposal chainutil.Amount
	...
	priorFeeOffers map[chainutil.Amount]*lnwire.ClosingSigned
	...
	localInternalKey fn.Option[crypto.PublicKey]
...
func NewChanCloser(cfg ChanCloseCfg, deliveryScript DeliveryAddrWithKey,
	...
	return &ChanCloser{
		...
		priorFeeOffers: make(
			map[chainutil.Amount]*lnwire.ClosingSigned,
		),
		closer: closer,
	}
}
...
func (c *ChanCloser) auxCloseOutputs(
	closeFee chainutil.Amount) (fn.Option[AuxCloseOutputs], error) {
...
func (c *ChanCloser) proposeCloseSigned(fee chainutil.Amount) (
...
func feeInAcceptableRange(localFee, remoteFee chainutil.Amount) bool {
...
// our offered fee.
func ratchetFee(fee chainutil.Amount, up bool) chainutil.Amount {
...
func calcCompromiseFee(chanPoint wire.OutPoint, ourIdealFee, lastSentFee,
	remoteFee chainutil.Amount) chainutil.Amount {
