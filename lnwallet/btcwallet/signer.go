...
func (b *BtcWallet) deriveKeyByBIP32Path(path []uint32) (*crypto.PrivateKey,
	error) {
...
func (b *BtcWallet) deriveKeyByLocator(
	keyLoc keychain.KeyLocator) (*crypto.PrivateKey, error) {
...
func (b *BtcWallet) fetchPrivKey(
	keyDesc *keychain.KeyDescriptor) (*crypto.PrivateKey, error) {
	...
	hash160 := chainutil.Hash160(keyDesc.PubKey.SerializeCompressed())
	addr, err := chainutil.NewAddressWitnessPubKeyHash(hash160, b.netParams)
	if err != nil {
		return nil, err
	}
...
func maybeTweakPrivKey(signDesc *input.SignDescriptor,
	privKey *crypto.PrivateKey) (*crypto.PrivateKey, error) {

	var retPriv *crypto.PrivateKey
	switch {
...
func (b *BtcWallet) ComputeInputScript(tx *wire.MsgTx,
	...
	// this tweak to derive the final private key to be used for signing
	// this output.
	privKeyTweaker := func(k *crypto.PrivateKey) (*crypto.PrivateKey, error) {
