...
# fund_node funds the specified node with 5 FLC.
function fund_node() {
  local node="$1"
...
function connect_nodes() {
  ...
  $node1 connect "$KEY_2"@$node2:5521 > /dev/null
...
function setup_bitcoin() {
  echo "🔗 Setting up Flokicoin node"
