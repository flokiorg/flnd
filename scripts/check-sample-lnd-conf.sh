...
OPTIONS_NO_LND_DEFAULT_VALUE_CHECK="channel-max-fee-exposure adminmacaroonpath \
    ...
    backupfilepath maxchansize flokicoin.chaindir flokicoin.defaultchanconfs \
    flokicoin.defaultremotedelay flokicoin.dnsseed signrpc.signermacaroonpath \
...
for OPTION in $LND_OPTIONS; do
    ...
    if [[ "$OPTION" == *"="* ]]; then
        ...
        DEFAULT_VALUE_LND="$(echo $LND_HELP | \
            ...
            -e "s#$HOME/Library/Application Support/Flokicoin#~/.bitcoin#g" \
