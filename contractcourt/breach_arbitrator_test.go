...
func createInitChannels(t *testing.T) (
	*lnwallet.LightningChannel, *lnwallet.LightningChannel, error) {
	...
	aliceCommit := channeldb.ChannelCommitment{
		CommitHeight:  0,
		LocalBalance:  lnwire.NewMLokFromLokis(channelBal - commitFee),
		RemoteBalance: lnwire.NewMLokFromLokis(channelBal),
	...
	bobCommit := channeldb.ChannelCommitment{
		CommitHeight:  0,
		LocalBalance:  lnwire.NewMLokFromLokis(channelBal),
		RemoteBalance: lnwire.NewMLokFromLokis(channelBal - commitFee),
		FeePerKw:      chainutil.Amount(feePerKw),
		CommitFee:     commitFee,
