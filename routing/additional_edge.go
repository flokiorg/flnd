...
type AdditionalEdge interface {
	...
	// final hop.
	IntermediatePayloadSize(amount lnwire.MilliLoki, expiry uint32,
...
type PayloadSizeFunc func(amount lnwire.MilliLoki, expiry uint32,
	channelID uint64) uint64
...
func (p *PrivateEdge) IntermediatePayloadSize(amount lnwire.MilliLoki,
...
// IntermediatePayloadSize returns the sphinx payload size defined in BOLT04 if
// this edge were to be included in a route.
func (b *BlindedEdge) IntermediatePayloadSize(_ lnwire.MilliLoki, _ uint32,
	_ uint64) uint64 {
...
// hop in the route.
func defaultHopPayloadSize(amount lnwire.MilliLoki, expiry uint32,
	channelID uint64) uint64 {
