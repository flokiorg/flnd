...
func (r *Manager) createEdge(channel *channeldb.OpenChannel,
	...
	*models.ChannelEdgePolicy, error) {
	...
	copy(info.FlokicoinKey1Bytes[:], bitcoinKey1Bytes)
	copy(info.FlokicoinKey2Bytes[:], bitcoinKey2Bytes)
...
func (r *Manager) updateEdge(chanPoint wire.OutPoint,
	...
	edge.FeeProportionalMillionths = lnwire.MilliLoki(
		newSchema.FeeRate,
	)
...
func (r *Manager) getHtlcAmtLimits(ch *channeldb.OpenChannel) (
	lnwire.MilliLoki, lnwire.MilliLoki, error) {
