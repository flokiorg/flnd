...
func failPairResult(minPenalizeAmt lnwire.MilliLoki) pairResult {
	return pairResult{
		amt: minPenalizeAmt,
	}
}
...
func successPairResult(successAmt lnwire.MilliLoki) pairResult {
	return pairResult{
		success: true,
		amt:     successAmt,
	}
...
type mcRoute struct {
	...
	totalAmount  tlv.RecordT[tlv.TlvType1, lnwire.MilliLoki]
...
type mcHop struct {
	...
	amtToFwd         tlv.RecordT[tlv.TlvType2, lnwire.MilliLoki]
