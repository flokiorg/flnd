...
// FlokicoindFilteredChainView is an implementation of the FilteredChainView
// interface which is backed by bitcoind.
type FlokicoindFilteredChainView struct {
...
// A compile time check to ensure FlokicoindFilteredChainView implements the
// chainview.FilteredChainView.
var _ FilteredChainView = (*FlokicoindFilteredChainView)(nil)

// NewFlokicoindFilteredChainView creates a new instance of a FilteredChainView
// from RPC credentials and a ZMQ socket address for a bitcoind instance.
func NewFlokicoindFilteredChainView(
	chainConn *chain.LokidConn,
	blockCache *blockcache.BlockCache) *FlokicoindFilteredChainView {

	chainView := &FlokicoindFilteredChainView{
...
func (b *FlokicoindFilteredChainView) Start() error {
	// Already started?
...
//
// NOTE: This is part of the FilteredChainView interface.
func (b *FlokicoindFilteredChainView) Stop() error {
	log.Debug("FlokicoindFilteredChainView stopping")
	defer log.Debug("FlokicoindFilteredChainView stopped")
...
func (b *FlokicoindFilteredChainView) onFilteredBlockConnected(height int32,
...
func (b *FlokicoindFilteredChainView) onFilteredBlockDisconnected(height int32,
	hash chainhash.Hash) {
...
//
// NOTE: This is part of the FilteredChainView interface.
func (b *FlokicoindFilteredChainView) FilterBlock(blockHash *chainhash.Hash) (*FilteredBlock, error) {
	req := &filterBlockReq{
		blockHash: blockHash,
...
func (b *FlokicoindFilteredChainView) chainFilterer() {
	defer b.wg.Done()
	...
	decodeJSONBlock := func(block *chainjson.RescannedBlock,
...
//
// NOTE: This is part of the FilteredChainView interface.
func (b *FlokicoindFilteredChainView) UpdateFilter(ops []graphdb.EdgePoint,
...
//
// NOTE: This is part of the FilteredChainView interface.
func (b *FlokicoindFilteredChainView) FilteredBlocks() <-chan *FilteredBlock {
...
//
// NOTE: This is part of the FilteredChainView interface.
func (b *FlokicoindFilteredChainView) DisconnectedBlocks() <-chan *FilteredBlock {
	return b.blockQueue.staleBlocks
}

// GetBlock is used to retrieve the block with the given hash. This function
// wraps the blockCache's GetBlock function.
func (b *FlokicoindFilteredChainView) GetBlock(hash *chainhash.Hash) (
	*wire.MsgBlock, error) {
