...
func newPaymentLifecycle(r *ChannelRouter, feeLimit lnwire.MilliLoki,
...
func (p *paymentLifecycle) calcFeeBudget(
	feesPaid lnwire.MilliLoki) lnwire.MilliLoki {
...
func (p *paymentLifecycle) registerAttempt(rt *route.Route,
	remainingAmt lnwire.MilliLoki) (*paymentsdb.HTLCAttempt, error) {
...
func (p *paymentLifecycle) amendFirstHopData(rt *route.Route) error {
	...
	type extraDataRequest struct {
		...
		amount fn.Option[lnwire.MilliLoki]
	}
	...
	result.amount.WhenSome(func(amount lnwire.MilliLoki) {
		rt.FirstHopAmount = tlv.NewRecordT[tlv.TlvType0](
...
func (p *paymentLifecycle) handleFailureMessage(rt *route.Route,
	...
	errSource, err := crypto.ParsePubKey(errVertex[:])
	if err != nil {
