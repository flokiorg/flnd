...
func (m *mockBandwidthHints) availableChanBandwidth(channelID uint64,
	_ lnwire.MilliLoki) (lnwire.MilliLoki, bool) {
...
func (c *integratedRoutingContext) testPayment(maxParts uint32,
	...
	getBandwidthHints := func(_ Graph) (bandwidthHints, error) {
		...
		bandwidthHints := map[uint64]lnwire.MilliLoki{}
	...
	session.minShardAmt = lnwire.NewMLokFromLokis(5000)
	...
	for {
		...
		route, err := session.RequestRoute(
			amtRemaining, lnwire.MaxMilliLoki, inFlightHtlcs, 0,
