...
func TestBandwidthManager(t *testing.T) {
	var (
		chan1ID      uint64           = 101
		chan2ID      uint64           = 102
		chanCapacity chainutil.Amount = 100000
	)
	...
	testCases := []struct {
		...
		expectedBandwidth lnwire.MilliLoki
		expectFound       bool
	}{
		{
...
func (*mockTrafficShaper) PaymentBandwidth(_, _, _ fn.Option[tlv.Blob],
	linkBandwidth, _ lnwire.MilliLoki,
	_ lnwallet.AuxHtlcView, _ route.Vertex) (lnwire.MilliLoki, error) {
...
func (*mockTrafficShaper) ProduceHtlcExtraData(totalAmount lnwire.MilliLoki,
	_ lnwire.CustomRecords, _ route.Vertex) (lnwire.MilliLoki,
