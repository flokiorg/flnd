...
var (
	...
	DefaultShardMinAmt = lnwire.NewMLokFromLokis(10000)
)
...
type PaymentSession interface {
	...
	// during path finding.
	RequestRoute(maxAmt, feeLimit lnwire.MilliLoki,
	...
	// if nothing found.
	GetAdditionalEdgePolicy(pubKey *crypto.PublicKey,
...
func (p *paymentSession) RequestRoute(maxAmt, feeLimit lnwire.MilliLoki,
	activeShards, height uint32,
...
func (p *paymentSession) UpdateAdditionalEdge(msg *lnwire.ChannelUpdate1,
	...
	policy.FeeBaseMSat = lnwire.MilliLoki(msg.BaseFee)
	policy.FeeProportionalMillionths = lnwire.MilliLoki(msg.FeeRate)
...
// found.
func (p *paymentSession) GetAdditionalEdgePolicy(pubKey *crypto.PublicKey,
	channelID uint64) *models.CachedEdgePolicy {
