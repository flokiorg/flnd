...
func (m *mockPaymentSessionOld) RequestRoute(_, _ lnwire.MilliLoki,
...
func (m *mockPaymentSessionOld) UpdateAdditionalEdge(_ *lnwire.ChannelUpdate1,
	_ *crypto.PublicKey, _ *models.CachedEdgePolicy) bool {

	return false
}

func (m *mockPaymentSessionOld) GetAdditionalEdgePolicy(_ *crypto.PublicKey,
...
func (m *mockPaymentSession) RequestRoute(maxAmt, feeLimit lnwire.MilliLoki,
...
func (m *mockPaymentSession) UpdateAdditionalEdge(msg *lnwire.ChannelUpdate1,
	pubKey *crypto.PublicKey, policy *models.CachedEdgePolicy) bool {

	args := m.Called(msg, pubKey, policy)
	return args.Bool(0)
}

func (m *mockPaymentSession) GetAdditionalEdgePolicy(pubKey *crypto.PublicKey,
...
func (m *mockLink) AuxBandwidth(lnwire.MilliLoki, lnwire.ShortChannelID,
	fn.Option[tlv.Blob],
