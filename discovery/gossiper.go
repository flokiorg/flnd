...
import (
	...
	"github.com/flokiorg/flnd/lnwallet/chanvalidate"
	"github.com/flokiorg/flnd/lnwire"
	"github.com/flokiorg/flnd/multimutex"
...
func ChannelCapacity(capacity chainutil.Amount) OptionalMsgField {
...
// cache.
func sourceToPub(pk *crypto.PublicKey) [33]byte {
	var pub [33]byte
...
func (d *AuthenticatedGossiper) retransmitStaleAnns(ctx context.Context,
	...
	err := d.cfg.Graph.ForAllOutgoingChannels(ctx, func(
		...
		if !edge.MessageFlags.HasMaxHtlc() {
			...
			edge.MaxHTLC = lnwire.NewMSatFromLokis(info.Capacity)
...
func (d *AuthenticatedGossiper) fetchPKScript(chanID lnwire.ShortChannelID) (
	txscript.ScriptClass, chainutil.Address, error) {
	...
	*lnwire.ChannelUpdate1, error) {
	...
	if info.AuthProof != nil {
		...
		chanAnn = &lnwire.ChannelAnnouncement1{
			...
			FlokicoinKey1:   info.FlokicoinKey1Bytes,
			Features:        lnwire.NewRawFeatureVector(),
			FlokicoinKey2:   info.FlokicoinKey2Bytes,
		...
		chanAnn.FlokicoinSig1, err = lnwire.NewSigFromECDSARawSignature(
			info.AuthProof.FlokicoinSig1Bytes,
		)
		if err != nil {
			return nil, nil, err
		}
		chanAnn.FlokicoinSig2, err = lnwire.NewSigFromECDSARawSignature(
			info.AuthProof.FlokicoinSig2Bytes,
		)
		if err != nil {
			return nil, nil, err
		}
...
func IsKeepAliveUpdate(update *lnwire.ChannelUpdate1,
	...
	if lnwire.MilliLoki(update.BaseFee) != prev.FeeBaseMSat {
		return false
	}
	if lnwire.MilliLoki(update.FeeRate) != prev.FeeProportionalMillionths {
		return false
	}
...
func (d *AuthenticatedGossiper) handleChanAnnouncement(ctx context.Context,
	...
	if nMsg.isRemote {
		...
		proof = &models.ChannelAuthProof{
			...
			FlokicoinSig1Bytes: ann.FlokicoinSig1.ToSignatureBytes(),
			FlokicoinSig2Bytes: ann.FlokicoinSig2.ToSignatureBytes(),
		}
	}
	...
	edge := &models.ChannelEdgeInfo{
		...
		FlokicoinKey1Bytes: ann.FlokicoinKey1,
		FlokicoinKey2Bytes: ann.FlokicoinKey2,
		AuthProof:          proof,
...
func (d *AuthenticatedGossiper) handleChanUpdate(ctx context.Context,
	...
	update := &models.ChannelEdgePolicy{
		...
		FeeBaseMSat:               lnwire.MilliLoki(upd.BaseFee),
		FeeProportionalMillionths: lnwire.MilliLoki(upd.FeeRate),
...
func (d *AuthenticatedGossiper) handleAnnSig(ctx context.Context,
	...
	if isFirstNode {
		...
		dbProof.FlokicoinSig1Bytes = ann.FlokicoinSignature.ToSignatureBytes()
		dbProof.FlokicoinSig2Bytes = oppProof.FlokicoinSignature.ToSignatureBytes()
	} else {
		dbProof.NodeSig1Bytes = oppProof.NodeSignature.ToSignatureBytes()
		dbProof.NodeSig2Bytes = ann.NodeSignature.ToSignatureBytes()
		dbProof.FlokicoinSig1Bytes = oppProof.FlokicoinSignature.ToSignatureBytes()
		dbProof.FlokicoinSig2Bytes = ann.FlokicoinSignature.ToSignatureBytes()
	}
...
// pubkey.
func (d *AuthenticatedGossiper) ShouldDisconnect(pubkey *crypto.PublicKey) (
	bool, error) {
...
func (d *AuthenticatedGossiper) validateFundingTransaction(_ context.Context,
	...
	tapscriptRoot fn.Option[chainhash.Hash]) (wire.OutPoint, chainutil.Amount,
	[]byte, error) {
	...
	fundingPkScript, err := makeFundingScript(
		ann.FlokicoinKey1[:], ann.FlokicoinKey2[:], ann.Features,
		tapscriptRoot,
	)
	if err != nil {
	...
	return *fundingPoint, chainutil.Amount(chanUtxo.Value), fundingPkScript,
		nil
}
...
func makeFundingScript(bitcoinKey1, bitcoinKey2 []byte,
	...
	if chanFeatureBits.HasFeature(
		...
		pubKey1, err := crypto.ParsePubKey(bitcoinKey1)
		if err != nil {
			return nil, err
		}
		pubKey2, err := crypto.ParsePubKey(bitcoinKey2)
		if err != nil {
			return nil, err
		}
