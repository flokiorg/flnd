...
func TestPrepareAddOnion(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			targetIPAddress: "",
			cfg:             AddOnionConfig{VirtualPort: 5521},
			expectedCmd:     "ADD_ONION NEW:ED25519-V3 Port=5521,5521 ",
			expectedErr:     nil,
		},
		{
		...
		},
		{
			...
			expectedCmd: "ADD_ONION NEW:ED25519-V3 " +
				"Port=5521,127.0.0.1:18000 " +
				"Port=5521,127.0.0.1:18001 ",
			expectedErr: nil,
		},
		{
