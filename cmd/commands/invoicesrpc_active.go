...
var addHoldInvoiceCommand = cli.Command{
	...
	to specify the amount of loki they wish to send.`,
	ArgsUsage: "hash [amt]",
	Flags: []cli.Flag{
		cli.StringFlag{
			Name: "memo",
		...
		cli.Int64Flag{
			Name:  "amt",
			Usage: "the amt of loki in this invoice",
		},
		cli.Int64Flag{
			Name:  "amt_msat",
			Usage: "the amt of milliloki in this invoice",
		},
		cli.StringFlag{
		...
		cli.Uint64Flag{
			...
			Usage: "The minimum CLTV delta to use for the final " +
				...
				"'flokicoin.timelockdelta' option.",
		},
		cli.BoolFlag{
			Name: "private",
