...
// Ensure FlokicoindNotifier implements the ChainNotifier interface at compile
// time.
var _ chainntnfs.ChainNotifier = (*FlokicoindNotifier)(nil)

// Ensure FlokicoindNotifier implements the MempoolWatcher interface at compile
// time.
...
func New(chainConn *chain.LokidConn, chainParams *chaincfg.Params,
	spendHintCache chainntnfs.SpendHintCache,
	confirmHintCache chainntnfs.ConfirmHintCache,
	blockCache *blockcache.BlockCache) *FlokicoindNotifier {

	notifier := &FlokicoindNotifier{
...
// Stop shutsdown the FlokicoindNotifier.
func (b *FlokicoindNotifier) Stop() error {
...
func (b *FlokicoindNotifier) Started() bool {
...
func (b *FlokicoindNotifier) notificationDispatcher() {
	defer b.wg.Done()
	...
	for {
		...
		case ntfn := <-b.chainConn.Notifications():
			...
			case chain.RelevantTx:
				tx := chainutil.NewTx(&item.TxRecord.MsgTx)
...
func (b *FlokicoindNotifier) handleRelevantTx(tx *chainutil.Tx,
...
func (b *FlokicoindNotifier) historicalConfDetails(confRequest chainntnfs.ConfRequest,
...
func (b *FlokicoindNotifier) confDetailsManually(confRequest chainntnfs.ConfRequest,
...
func (b *FlokicoindNotifier) handleBlockConnected(block chainntnfs.BlockEpoch) error {
	...
	utilBlock := chainutil.NewBlock(rawBlock)
...
func (b *FlokicoindNotifier) notifyBlockEpochs(newHeight int32, newSha *chainhash.Hash,
...
func (b *FlokicoindNotifier) notifyBlockEpochClient(epochClient *blockEpochRegistration,
...
func (b *FlokicoindNotifier) RegisterSpendNtfn(outpoint *wire.OutPoint,
	...
	if err != nil {
		...
		jsonErr, ok := err.(*chainjson.RPCError)
		if !ok || jsonErr.Code != chainjson.ErrRPCNoTxInfo {
...
func (b *FlokicoindNotifier) historicalSpendDetails(
...
func (b *FlokicoindNotifier) RegisterConfirmationsNtfn(txid *chainhash.Hash,
...
// epochCancel is a message sent to the FlokicoindNotifier when a client wishes
...
func (b *FlokicoindNotifier) RegisterBlockEpochNtfn(
...
func (b *FlokicoindNotifier) GetBlock(hash *chainhash.Hash) (*wire.MsgBlock,
	error) {
...
func (b *FlokicoindNotifier) SubscribeMempoolSpent(
...
//
// NOTE: part of the MempoolWatcher interface.
func (b *FlokicoindNotifier) CancelMempoolSpendEvent(
...
//
// NOTE: part of the MempoolWatcher interface.
func (b *FlokicoindNotifier) LookupInputMempoolSpend(
