...
// the spending of given inputs. This is mounted to either `FlokicoindNotifier`
...
func (m *MempoolNotifier) UnsubsribeConfirmedSpentTx(tx *chainutil.Tx) {
...
func (m *MempoolNotifier) ProcessRelevantSpendTx(tx *chainutil.Tx) error {
...
// returns them.
func (m *MempoolNotifier) findRelevantInputs(tx *chainutil.Tx) (inputsWithTx,
	error) {
