...
// Flokicoin light client. Unlike other implementations, this implementation
...
func (n *NeutrinoNotifier) onFilteredBlockConnected(height int32,
	header *wire.BlockHeader, txns []*chainutil.Tx) {
...
func (n *NeutrinoNotifier) onRelevantTx(tx *chainutil.Tx, details *chainjson.BlockDetails) {
	select {
...
func (n *NeutrinoChainConn) GetBlockHeaderVerbose(blockHash *chainhash.Hash) (
	*chainjson.GetBlockHeaderVerboseResult, error) {
	...
	return &chainjson.GetBlockHeaderVerboseResult{Height: int32(height)}, nil
}
