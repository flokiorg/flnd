...
func (b *BtcdNotifier) onRedeemingTx(tx *chainutil.Tx, details *chainjson.BlockDetails) {
...
func (b *BtcdNotifier) handleRelevantTx(tx *chainutil.Tx,
...
func (b *BtcdNotifier) handleBlockConnected(epoch chainntnfs.BlockEpoch) error {
	...
	newBlock := &filteredBlock{
		...
		block:   chainutil.NewBlock(rawBlock),
		connect: true,
	}
