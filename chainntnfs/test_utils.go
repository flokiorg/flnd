...
func randPubKeyHashScript() ([]byte, *crypto.PrivateKey, error) {
	...
	addrScript, err := chainutil.NewAddressWitnessPubKeyHash(
...
func CreateSpendableOutput(t *testing.T,
	miner *rpctest.Harness) (*wire.OutPoint, *wire.TxOut, *crypto.PrivateKey) {
...
func CreateSpendTx(t *testing.T, prevOutPoint *wire.OutPoint,
	prevOutput *wire.TxOut, privKey *crypto.PrivateKey) *wire.MsgTx {
