...
func (n *TxNotifier) ProcessRelevantSpendTx(tx *chainutil.Tx,
...
func (n *TxNotifier) ConnectTip(block *chainutil.Block,
	blockHeight uint32) error {
...
func (n *TxNotifier) filterTx(block *chainutil.Block, tx *chainutil.Tx,
