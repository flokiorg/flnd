...
var (
	...
	dummyPubKey1, _ = crypto.ParsePubKey(hexDecode(
		"02ec95e4e8ad994861b95fc5986eedaac24739e5ea3d0634db4c8ccd44cd" +
			"a126ea",
	))
	dummyPubKey2, _ = crypto.ParsePubKey(hexDecode(
		"0356167ba3e54ac542e86e906d4186aba9ca0b9df45001c62b753d33fe06" +
			"f5b4e8",
	))
	dummyPubKey3, _ = crypto.ParsePubKey(hexDecode(
	...
	testVector100Key1, _ = crypto.ParsePubKey(hexDecode(
		"02F9308A019258C31049344F85F89D5229B531C845836F99B08601F113BC" +
			"E036F9",
	))
	testVector100Key2, _ = crypto.ParsePubKey(hexDecode(
		"03DFF1D77F2A671C5F36183726DB2341BE58FEAE1DA2DECED843240F7B50" +
			"2BA659",
	))
	testVector100Key3, _ = crypto.ParsePubKey(hexDecode(
...
func TestMuSig2CombineKeys(t *testing.T) {
	...
	testCases := []struct {
		...
		keys:     []*crypto.PublicKey{dummyPubKey1, dummyPubKey2},
