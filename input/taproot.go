...
// tree leaves.
func TapscriptFullTree(internalKey *crypto.PublicKey,
...
func TapscriptPartialReveal(internalKey *crypto.PublicKey,
...
// and root hash.
func TapscriptRootHashOnly(internalKey *crypto.PublicKey,
...
// key.
func TapscriptFullKeyOnly(taprootKey *crypto.PublicKey) *waddrmgr.Tapscript {
	return &waddrmgr.Tapscript{
