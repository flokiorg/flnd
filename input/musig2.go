...
import (
	...
	"github.com/flokiorg/flnd/internal/musig2v040"
...
const (
	...
	// uses the github.com/flokiorg/go-flokicoin/crypto/schnorr/musig2 package
...
type MuSig2Signer interface {
	...
	MuSig2CreateSession(MuSig2Version, keychain.KeyLocator,
		[]*crypto.PublicKey, *MuSig2Tweaks, [][musig2.PubNonceSize]byte,
...
type MuSig2Context interface {
	...
	TaprootInternalKey() (*crypto.PublicKey, error)
}
...
type MuSig2SessionInfo struct {
	...
	TaprootInternalKey *crypto.PublicKey
...
func MuSig2ParsePubKeys(bipVersion MuSig2Version,
	rawPubKeys [][]byte) ([]*crypto.PublicKey, error) {

	allSignerPubKeys := make([]*crypto.PublicKey, len(rawPubKeys))
	if len(rawPubKeys) < 2 {
...
func MuSig2CombineKeys(bipVersion MuSig2Version,
	allSignerPubKeys []*crypto.PublicKey, sortKeys bool,
...
func combineKeysV100RC2(allSignerPubKeys []*crypto.PublicKey, sortKeys bool,
	tweaks *MuSig2Tweaks) (*musig2.AggregateKey, error) {
...
// draft version 0.4.0.
func combineKeysV040(allSignerPubKeys []*crypto.PublicKey, sortKeys bool,
	tweaks *MuSig2Tweaks) (*musig2.AggregateKey, error) {
...
func MuSig2CreateContext(bipVersion MuSig2Version, privKey *crypto.PrivateKey,
	allSignerPubKeys []*crypto.PublicKey, tweaks *MuSig2Tweaks,
...
func createContextV100RC2(privKey *crypto.PrivateKey,
	allSignerPubKeys []*crypto.PublicKey, tweaks *MuSig2Tweaks,
	localNonces *musig2.Nonces,
...
// draft version 0.4.0.
func createContextV040(privKey *crypto.PrivateKey,
	allSignerPubKeys []*crypto.PublicKey, tweaks *MuSig2Tweaks,
	_ *musig2.Nonces,
...
func NewMuSig2SessionID(combinedKey *crypto.PublicKey,
