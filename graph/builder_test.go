...
func TestAddProof(t *testing.T) {
	...
	copy(edge.FlokicoinKey1Bytes[:], bitcoinKey1.SerializeCompressed())
	copy(edge.FlokicoinKey2Bytes[:], bitcoinKey2.SerializeCompressed())
...
func TestWakeUpOnStaleBranch(t *testing.T) {
	...
	copy(edge1.FlokicoinKey1Bytes[:], bitcoinKey1.SerializeCompressed())
	copy(edge1.FlokicoinKey2Bytes[:], bitcoinKey2.SerializeCompressed())
	...
	copy(edge2.FlokicoinKey1Bytes[:], bitcoinKey1.SerializeCompressed())
	copy(edge2.FlokicoinKey2Bytes[:], bitcoinKey2.SerializeCompressed())
...
func TestDisconnectedBlocks(t *testing.T) {
	...
	edge1 := &models.ChannelEdgeInfo{
		...
		NodeKey1Bytes:      node1.PubKeyBytes,
		NodeKey2Bytes:      node2.PubKeyBytes,
		FlokicoinKey1Bytes: node1.PubKeyBytes,
		FlokicoinKey2Bytes: node2.PubKeyBytes,
		AuthProof: &models.ChannelAuthProof{
			NodeSig1Bytes:      testSig.Serialize(),
			NodeSig2Bytes:      testSig.Serialize(),
			FlokicoinSig1Bytes: testSig.Serialize(),
...
func (m *mockLink) Bandwidth() lnwire.MilliLoki {
	return m.bandwidth
}
...
func (m *mockLink) MayAddOutgoingHtlc(_ lnwire.MilliLoki) error {
