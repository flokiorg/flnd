...
func randEdgePolicy(chanID *lnwire.ShortChannelID,
	...
	return &models.ChannelEdgePolicy{
		...
		MinHTLC:                   lnwire.MilliLoki(prand.Int31()),
		MaxHTLC:                   lnwire.MilliLoki(prand.Int31()),
		FeeBaseMSat:               lnwire.MilliLoki(prand.Int31()),
		FeeProportionalMillionths: lnwire.MilliLoki(prand.Int31()),
...
func createChannelEdge(bitcoinKey1, bitcoinKey2 []byte,
	chanValue chainutil.Amount, fundingHeight uint32) ([]byte, *wire.MsgTx,
