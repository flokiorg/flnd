...
func (s *SQLStore) AddrsForNode(ctx context.Context,
	nodePub *crypto.PublicKey) (bool, []net.Addr, error) {
...
func (s *SQLStore) LookupAlias(ctx context.Context,
	pub *crypto.PublicKey) (string, error) {
	...
	err := s.db.ExecTx(ctx, sqldb.ReadTxOpt(), func(db SQLQueries) error {
		handleChannel := func(_ context.Context,
			...
			pkScript, err := genMultiSigP2WSH(
				channel.FlokicoinKey1, channel.FlokicoinKey2,
			)
			if err != nil {
				return err
			}
	...
	err := s.db.ExecTx(ctx, sqldb.WriteTxOpt(), func(db SQLQueries) error {
		res, err := db.AddV1ChannelProof(
			ctx, sqlc.AddV1ChannelProofParams{
				...
				Flokicoin1Signature: proof.FlokicoinSig1Bytes,
				Flokicoin2Signature: proof.FlokicoinSig2Bytes,
			},
		)
		if err != nil {
...
func buildCacheableChannelInfo(scid []byte, capacity int64, node1Pub,
	...
	return &models.CachedEdgeInfo{
		...
		Capacity:      chainutil.Amount(capacity),
	}
}
...
func insertChannel(ctx context.Context, db SQLQueries,
	...
	createParams := sqlc.CreateChannelParams{
		...
		Capacity:      capacity,
		FlokicoinKey1: edge.FlokicoinKey1Bytes[:],
		FlokicoinKey2: edge.FlokicoinKey2Bytes[:],
	}
	...
	if edge.AuthProof != nil {
		...
		createParams.Flokicoin1Signature = proof.FlokicoinSig1Bytes
		createParams.Flokicoin2Signature = proof.FlokicoinSig2Bytes
	}
...
func buildEdgeInfoWithBatchData(chain chainhash.Hash,
	...
	copy(btcKey1[:], dbChan.FlokicoinKey1)
	copy(btcKey2[:], dbChan.FlokicoinKey2)
	...
	channel := &models.ChannelEdgeInfo{
		...
		NodeKey1Bytes:      node1,
		NodeKey2Bytes:      node2,
		FlokicoinKey1Bytes: btcKey1,
		FlokicoinKey2Bytes: btcKey2,
		ChannelPoint:       *op,
		Capacity:           chainutil.Amount(dbChan.Capacity.Int64),
		Features:           fv,
	...
	if len(dbChan.Flokicoin1Signature) > 0 {
		channel.AuthProof = &models.ChannelAuthProof{
			NodeSig1Bytes:      dbChan.Node1Signature,
			NodeSig2Bytes:      dbChan.Node2Signature,
			FlokicoinSig1Bytes: dbChan.Flokicoin1Signature,
			FlokicoinSig2Bytes: dbChan.Flokicoin2Signature,
		}
	}
...
func buildChanPolicy(dbPolicy sqlc.GraphChannelPolicy, channelID uint64,
	...
	return &models.ChannelEdgePolicy{
		...
		FeeProportionalMillionths: lnwire.MilliLoki(dbPolicy.FeePpm),
		ToNode:                    toNode,
