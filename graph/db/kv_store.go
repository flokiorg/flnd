...
func putChanEdgeInfo(edgeIndex kvdb.RwBucket,
	...
	if _, err := b.Write(edgeInfo.FlokicoinKey1Bytes[:]); err != nil {
		return err
	}
	if _, err := b.Write(edgeInfo.FlokicoinKey2Bytes[:]); err != nil {
		return err
	}
	...
	if authProof != nil {
		...
		bitcoinSig1 = authProof.FlokicoinSig1Bytes
		bitcoinSig2 = authProof.FlokicoinSig2Bytes
	}
...
func deserializeChanEdgeInfo(r io.Reader) (*models.ChannelEdgeInfo, error) {
	...
	if _, err := io.ReadFull(r, edgeInfo.FlokicoinKey1Bytes[:]); err != nil {
		return nil, err
	}
	if _, err := io.ReadFull(r, edgeInfo.FlokicoinKey2Bytes[:]); err != nil {
		return nil, err
	}
	...
	proof.FlokicoinSig1Bytes, err = wire.ReadVarBytes(r, 0, 80, "sigs")
	if err != nil {
		return nil, err
	}
	proof.FlokicoinSig2Bytes, err = wire.ReadVarBytes(r, 0, 80, "sigs")
	if err != nil {
		return nil, err
	}
...
func deserializeChanEdgePolicyRaw(r io.Reader) (*models.ChannelEdgePolicy,
	...
	edge.MinHTLC = lnwire.MilliLoki(n)

	if err := binary.Read(r, byteOrder, &n); err != nil {
		return nil, err
	}
	edge.FeeBaseMSat = lnwire.MilliLoki(n)

	if err := binary.Read(r, byteOrder, &n); err != nil {
		return nil, err
	}
	edge.FeeProportionalMillionths = lnwire.MilliLoki(n)
	...
	if edge.MessageFlags.HasMaxHtlc() {
		...
		edge.MaxHTLC = lnwire.MilliLoki(maxHtlc)
