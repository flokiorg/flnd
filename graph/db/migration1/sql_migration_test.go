...
import (
	...
	"github.com/flokiorg/flnd/graph/db/migration1/models"
...
func makeTestChannel(t *testing.T,
	...
	c := &models.ChannelEdgeInfo{
		...
		FlokicoinKey1Bytes: genPubKey(t),
		FlokicoinKey2Bytes: genPubKey(t),
...
func TestMigrationWithChannelDB(t *testing.T) {
	...
	UseLogger(flog.NewSLogger(flog.NewDefaultHandler(os.Stdout)))
...
func genRandomChannel(rt *rapid.T,
	...
	capacity := rapid.Int64Range(1, chainutil.MaxLoki).Draw(rt, "capacity")
	...
	authProof := &models.ChannelAuthProof{
		...
		FlokicoinSig1Bytes: btc1Sig.RawBytes(),
		FlokicoinSig2Bytes: btc2Sig.RawBytes(),
	}
	...
	info := &models.ChannelEdgeInfo{
		...
		FlokicoinKey1Bytes: bitcoinKey1Bytes,
		FlokicoinKey2Bytes: bitcoinKey2Bytes,
		Features:           features,
		AuthProof:          authProof,
