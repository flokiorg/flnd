...
type ChannelEdgeInfo struct {
	...
	// FlokicoinKey1Bytes is the raw public key of the first node.
	FlokicoinKey1Bytes [33]byte

	// FlokicoinKey2Bytes is the raw public key of the first node.
	FlokicoinKey2Bytes [33]byte
...
func (c *ChannelEdgeInfo) NodeKey1() (*crypto.PublicKey, error) {
	return crypto.ParsePubKey(c.NodeKey1Bytes[:])
}
...
func (c *ChannelEdgeInfo) NodeKey2() (*crypto.PublicKey, error) {
	return crypto.ParsePubKey(c.NodeKey2Bytes[:])
}
