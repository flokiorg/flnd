...
type MailBox interface {
	...
	DustPackets() (lnwire.MilliLoki, lnwire.MilliLoki)
...
func (m *memoryMailBox) DustPackets() (lnwire.MilliLoki,
	lnwire.MilliLoki) {
	...
	var (
		localDustSum  lnwire.MilliLoki
		remoteDustSum lnwire.MilliLoki
	)
