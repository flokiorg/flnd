...
func (s *mockServer) IdentityKey() *crypto.PublicKey {
	pubkey, _ := crypto.ParsePubKey(s.id[:])
	return pubkey
}
...
func (f *mockChannelLink) getDustClosure() dustClosure {
	dustLimit := chainutil.Amount(400)
	return dustHelper(
		channeldb.SingleFunderTweaklessBit, dustLimit, dustLimit,
	)
}

func (f *mockChannelLink) getCommitFee(remote bool) chainutil.Amount {
	return 0
}
...
func (f *mockChannelLink) CheckHtlcForward([32]byte, lnwire.MilliLoki,
	lnwire.MilliLoki, uint32, uint32, models.InboundFee, uint32,
...
func (f *mockChannelLink) CheckHtlcTransit(payHash [32]byte,
	amt lnwire.MilliLoki, timeout uint32,
...
func (f *mockChannelLink) Stats() (
	uint64, lnwire.MilliLoki, lnwire.MilliLoki) {
...
func (f *mockChannelLink) Bandwidth() lnwire.MilliLoki {
	return 99999999
}
...
func (f *mockChannelLink) MayAddOutgoingHtlc(lnwire.MilliLoki) error    { return nil }
...
func (f *mockChannelLink) AuxBandwidth(lnwire.MilliLoki,
...
func (i *mockInvoiceRegistry) NotifyExitHopHtlc(rhash lntypes.Hash,
	amt lnwire.MilliLoki, expiry uint32, currentHeight int32,
