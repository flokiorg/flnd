...
type ForwardingInfo struct {
	...
	// AmountToForward is the amount of milli-loki that the receiving
	// node should forward to the next hop.
	AmountToForward lnwire.MilliLoki
...
// invoice resolution.
func ValidateFinalHtlc(amt lnwire.MilliLoki, expiry, heightNow,
