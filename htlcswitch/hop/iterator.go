...
func deriveBlindedRouteForwardingInfo(r *sphinxHopIterator,
	routeData *record.BlindedRouteData, payload *Payload,
	routeRole RouteRole, blindingPoint *crypto.PublicKey) (*Payload,
	RouteRole, error) {
	...
	nextEph, err := routeData.NextBlindingOverride.UnwrapOrFuncErr(
		func() (tlv.RecordT[tlv.TlvType8, *crypto.PublicKey], error) {
...
func checkForDummyHop(routeData *record.BlindedRouteData,
	routerPubKey *crypto.PublicKey) bool {

	var isDummy bool
	routeData.NextNodeID.WhenSome(
		func(r tlv.RecordT[tlv.TlvType4, *crypto.PublicKey]) {
...
func peelBlindedPathDummyHop(r *sphinxHopIterator, cltvExpiryDelta uint32,
	fwdAmt lnwire.MilliLoki, routeRole RouteRole,
	nextEph tlv.RecordT[tlv.TlvType8, *crypto.PublicKey]) (*Payload,
	RouteRole, error) {
...
func decryptAndValidateBlindedRouteData(r *sphinxHopIterator,
	payload *Payload) (*record.BlindedRouteData, *crypto.PublicKey, error) {
...
type BlindingKit struct {
	...
	IncomingAmount lnwire.MilliLoki
}
...
func (b *BlindingKit) getBlindingPoint(payloadBlinding *crypto.PublicKey) (
...
//
//nolint:ll,dupword
func calculateForwardingAmount(incomingAmount, baseFee lnwire.MilliLoki,
	proportionalFee uint32) (lnwire.MilliLoki, error) {
	...
	return lnwire.MilliLoki(ceiling), nil
}
...
func (p *OnionProcessor) ReconstructHopIterator(r io.Reader, rHash []byte,
	...
	blindingInfo.BlindingKey.WhenSome(func(
		r tlv.RecordT[lnwire.BlindingPointTlvType, *crypto.PublicKey]) {
...
// returned.
func (p *OnionProcessor) ExtractErrorEncrypter(ephemeralKey *crypto.PublicKey) (
	ErrorEncrypter, lnwire.FailCode) {
