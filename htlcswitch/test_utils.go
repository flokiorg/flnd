...
func createTestChannel(t *testing.T, alicePrivKey, bobPrivKey []byte,
	...
	*testLightningChannel, error) {
	...
	aliceCommit := channeldb.ChannelCommitment{
		CommitHeight:  0,
		LocalBalance:  lnwire.NewMSatFromLokis(aliceAmount - commitFee),
		RemoteBalance: lnwire.NewMSatFromLokis(bobAmount),
		CommitFee:     commitFee,
	...
	bobCommit := channeldb.ChannelCommitment{
		CommitHeight:  0,
		LocalBalance:  lnwire.NewMSatFromLokis(bobAmount),
		RemoteBalance: lnwire.NewMSatFromLokis(aliceAmount - commitFee),
		CommitFee:     commitFee,
		FeePerKw:      chainutil.Amount(feePerKw),
