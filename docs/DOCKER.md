...
```shell
$  docker run --name lnd-testnet myrepository/lnd --flokicoin.active --flokicoin.testnet --flokicoin.node=neutrino --neutrino.connect=faucet.lightning.community
```
...
2018-05-01 02:28:01.201 [INF] RPCS: gRPC proxy started at 127.0.0.1:5050
2018-05-01 02:28:08.999 [INF] LNWL: Caught up to height 10000
2018-05-01 02:28:09.872 [INF] FLCN: Processed 10547 blocks in the last 10.23s (height 10547, 2012-05-28 05:02:32 +0000 UTC)
```
...
```shell
$  docker run --name=lnd-testnet -it myrepository/lnd:latest-tag --flokicoin.active --flokicoin.testnet --flokicoin.node=neutrino --neutrino.connect=faucet.lightning.community
```
