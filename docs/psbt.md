...
Flokicoin Transactions (PSBTs). `lnd`'s wallet now features a full set of PSBT
...
amounts to be in loki instead of fractions of a bitcoin.
...
The goal is to open a channel of 1'234'567 loki to the node
...
Please create a PSBT that sends 0.01234567 FLC (1234567 satoshi) to the funding address bcrt1qh33ghvgjj3ef625nl9jxz6nnrz2z9e65vsdey7w5msrklgr6rc0sv0s08q.
...
bitcoind:
    bitcoin-cli walletcreatefundedpsbt '[]' '${JSON.stringify(outputsFlokicoind)}' 0 '{"fee_rate": 15}'
