	...
	testCases := []testCase{{
		...
		coins: []wallet.Coin{{
			TxOut: wire.TxOut{
				...
				Value:    1 * btcutil.SatoshiPerFlokicoin,
			},
		}},
	}, {
		name: "spend more",
...
**PREFERRED**
```go
	coin := btcutil.SatoshiPerFlokicoin
	testCases := []testCase{
		{
			name: "spend exactly all",
			coins: []wallet.Coin{
...
```shell
$  go mod edit -replace=github.com/flokiorg/lightning-onion@v0.0.0-20180605012408-ac4d9da8f1d6=github.com/roasbeef/lightning-onion@2e5ae87696046298365ab43bcd1cf3a7a1d69695
```
