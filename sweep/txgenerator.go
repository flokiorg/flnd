...
func createSweepTx(inputs []input.Input, outputs []*wire.TxOut,
	...
	signer input.Signer) (*wire.MsgTx, chainutil.Amount, error) {
	...
	var (
		...
		requiredOutput chainutil.Amount
	...
	for _, o := range inputs {
		...
		totalInput += chainutil.Amount(o.SignDesc().Output.Value)
		requiredOutput += chainutil.Amount(o.RequiredTxOut().Value)
	}
	...
	for _, o := range outputs {
		sweepTx.AddTxOut(o)
		requiredOutput += chainutil.Amount(o.Value)
	}
