...
CREATE TABLE IF NOT EXISTS graph_channels (
    ...
    -- The capacity of the channel in milliloki. This is nullable since
...
CREATE TABLE IF NOT EXISTS graph_channel_policies (
    ...
    -- The base fee in milliloki that the node will charge for forwarding
    -- any HTLC.
    ...
    -- The optional base fee in milli-loki that the node will charge
    -- for incoming HTLCs.
