...
type FeeLimit_FixedMsat struct {
	// The fee limit expressed as a fixed amount of MilliLokis.
	//
	// The fields fixed and fixed_msat are mutually exclusive.
...
type SendRequest struct {
	...
	// The amount to send expressed in MilliLokis.
	//
	// The fields amt and amt_msat are mutually exclusive.
...
type ChannelAcceptRequest struct {
	...
	// The push amount of the proposed channel in MilliLokis.
	...
	// The maximum amount of coins in MilliLokis that can be pending in this
	// channel.
	...
	// The smallest HTLC in MilliLokis that the initiator will accept.
...
type ChannelAcceptResponse struct {
	...
	// The maximum amount of funds in MilliLokis that we allow the remote peer
	...
	// The minimum value in MilliLokis for incoming htlcs on the channel.
...
type BatchOpenChannel struct {
	...
	// The minimum value in MilliLoki we will require for incoming HTLCs on
	// the channel.
	...
	// The maximum amount of coins in MilliLoki that can be pending within
...
type HopHint struct {
	...
	ChanId uint64 `protobuf:"varint,2,opt,name=chan_id,json=chanId,proto3" json:"chan_id,omitempty"`
	// The base fee of the channel denominated in MilliLokis.
...
type Invoice struct {
	...
	// The amount that was accepted for this invoice, in MilliLokis. This will
