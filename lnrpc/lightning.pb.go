...
type OnionMessageUpdate struct {
	...
	CustomRecords map[uint64][]byte `protobuf:"bytes,6,rep,name=custom_records,json=customRecords,proto3" json:"custom_records,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type Utxo struct {
	...
	// The value of the unspent coin in loki
...
type OutputDetail struct {
	...
	// The value of the output coin in loki
...
type Transaction struct {
	...
	// The transaction amount, denominated in loki
...
type FeeLimit_Fixed struct {
	// The fee limit expressed as a fixed amount of loki.
	//
...
type FeeLimit_FixedMsat struct {
	// The fee limit expressed as a fixed amount of milliloki.
	//
	// The fields fixed and fixed_msat are mutually exclusive.
...
type ChannelAcceptRequest struct {
	...
	// The funding amount in loki that initiator wishes to use in the
	// channel.
	FundingAmt uint64 `protobuf:"varint,4,opt,name=funding_amt,json=fundingAmt,proto3" json:"funding_amt,omitempty"`
	// The push amount of the proposed channel in milliloki.
	...
	// The maximum amount of coins in milliloki that can be pending in this
	// channel.
	...
	// The minimum amount of loki the initiator requires us to have at all
	// times.
	...
	// The smallest HTLC in milliloki that the initiator will accept.
...
type ChannelAcceptResponse struct {
	...
	// The reserve amount in loki that we require the remote peer to adhere to.
	...
	// The maximum amount of funds in milliloki that we allow the remote peer
	...
	// The minimum value in milliloki for incoming htlcs on the channel.
...
type ChannelConstraints struct {
	...
	// The minimum loki this node is required to reserve in its balance.
	...
	// The dust limit (in loki) of the initiator's commitment tx.
...
type Channel struct {
	...
	// The required number of loki per kilo-weight that the requester will pay
	...
	// The total number of loki we've sent within this channel.
	TotalLokisSent int64 `protobuf:"varint,12,opt,name=total_satoshis_sent,json=totalSatoshisSent,proto3" json:"total_satoshis_sent,omitempty"`
	// The total number of loki we've received within this channel.
	TotalLokisReceived int64 `protobuf:"varint,13,opt,name=total_satoshis_received,json=totalSatoshisReceived,proto3" json:"total_satoshis_received,omitempty"`
	...
	// Deprecated. The minimum loki this node is required to reserve in its
	// balance.
	//
	// Deprecated: Marked as deprecated in lightning.proto.
	...
	// Deprecated. The minimum loki the other node is required to reserve in
	// its balance.
	//
	// Deprecated: Marked as deprecated in lightning.proto.
...
func (x *Channel) GetTotalLokisSent() int64 {
	if x != nil {
		return x.TotalLokisSent
	}
	return 0
}

func (x *Channel) GetTotalLokisReceived() int64 {
	if x != nil {
		return x.TotalLokisReceived
	}
	return 0
}
...
type ReadyForPsbtFunding struct {
	...
	// specified amount in loki needs to be sent to.
	...
	// The exact amount in loki that needs to be sent to the above address to
...
type BatchOpenChannel struct {
	...
	NodePubkey []byte `protobuf:"bytes,1,opt,name=node_pubkey,json=nodePubkey,proto3" json:"node_pubkey,omitempty"`
	// The number of loki the wallet should commit to the channel.
	...
	// The number of loki to push to the remote side as part of the initial
	// commitment state.
	...
	// The base fee charged regardless of the number of milli-loki sent.
	...
	// The number of loki we require the remote peer to reserve. This value,
...
type PendingChannelsResponse struct {
	...
	// The balance in loki encumbered in pending channels
...
type ChannelBalanceResponse struct {
	...
	// Deprecated. Sum of channels balances denominated in loki
	//
	// Deprecated: Marked as deprecated in lightning.proto.
	Balance int64 `protobuf:"varint,1,opt,name=balance,proto3" json:"balance,omitempty"`
	// Deprecated. Sum of channels pending balances denominated in loki
	//
	// Deprecated: Marked as deprecated in lightning.proto.
...
type QueryRoutesRequest struct {
	...
	PubKey string `protobuf:"bytes,1,opt,name=pub_key,json=pubKey,proto3" json:"pub_key,omitempty"`
	// The amount to send expressed in loki.
	//
	// The fields amt and amt_msat are mutually exclusive.
	Amt int64 `protobuf:"varint,2,opt,name=amt,proto3" json:"amt,omitempty"`
	// The amount to send expressed in milliloki.
	//
	// The fields amt and amt_msat are mutually exclusive.
	...
	// The maximum number of loki that will be paid as a fee of the payment.
...
type MPPRecord struct {
	...
	// The total amount in milli-loki being sent as part of a larger multi-path
...
type Route struct {
	...
	// loki, otherwise the route will fail at an intermediate node due to an
	...
	// payment and the value transported in the HTLC is different from the FLC
...
type NodeInfo struct {
	...
	// The sum of all channels capacity for the node, denominated in loki.
...
type ChannelAuthProof struct {
	...
	FlokicoinSig1 []byte `protobuf:"bytes,2,opt,name=bitcoin_sig1,json=bitcoinSig1,proto3" json:"bitcoin_sig1,omitempty"`
	...
	// MultiSigKey key of the channel encoded in DER format.
	FlokicoinSig2 []byte `protobuf:"bytes,4,opt,name=bitcoin_sig2,json=bitcoinSig2,proto3" json:"bitcoin_sig2,omitempty"`
}
...
func (x *ChannelAuthProof) GetFlokicoinSig1() []byte {
	if x != nil {
		return x.FlokicoinSig1
	}
	return nil
}
...
func (x *ChannelAuthProof) GetFlokicoinSig2() []byte {
	if x != nil {
		return x.FlokicoinSig2
	}
	return nil
}
...
type HopHint struct {
	...
	ChanId uint64 `protobuf:"varint,2,opt,name=chan_id,json=chanId,proto3" json:"chan_id,omitempty"`
	// The base fee of the channel denominated in milliloki.
...
type AMPInvoiceState struct {
	...
	// The total amount paid for the sub-invoice expressed in milli loki.
...
type Invoice struct {
	...
	// The value of this invoice in loki
	//
	...
	// The amount that was accepted for this invoice, in loki. This will ONLY
	...
	// The amount that was accepted for this invoice, in milliloki. This will
...
type PayReq struct {
	...
	NumLokis     int64                 `protobuf:"varint,3,opt,name=num_satoshis,json=numSatoshis,proto3" json:"num_satoshis,omitempty"`
...
func (x *PayReq) GetNumLokis() int64 {
	if x != nil {
		return x.NumLokis
	}
	return 0
...
type ChannelFeeReport struct {
	...
	// The amount charged per milli-loki transferred expressed in
	// millionths of a satoshi.
	FeePerMil int64 `protobuf:"varint,3,opt,name=fee_per_mil,json=feePerMil,proto3" json:"fee_per_mil,omitempty"`
	// The effective fee rate in milli-loki. Computed by dividing the
...
type FeeReportResponse struct {
	...
	// The total amount of fee revenue (in loki) the switch has collected
...
type InboundFee struct {
	...
	// The inbound base fee charged regardless of the number of milli-loki
	...
	// The effective inbound fee rate in micro-loki (parts per million).
...
type PolicyUpdateRequest struct {
	...
	// The effective fee rate in milli-loki. The precision of this value
	// goes up to 6 decimal places, so 1e-6.
	FeeRate float64 `protobuf:"fixed64,4,opt,name=fee_rate,json=feeRate,proto3" json:"fee_rate,omitempty"`
	// The effective fee rate in micro-loki (parts per million).
	...
	// If set, the maximum HTLC size in milli-loki. If unset, the maximum
	// HTLC will be unchanged.
	MaxHtlcMsat uint64 `protobuf:"varint,6,opt,name=max_htlc_msat,json=maxHtlcMsat,proto3" json:"max_htlc_msat,omitempty"`
	// The minimum HTLC size in milli-loki. Only applied if
...
type PendingChannelsResponse_PendingChannel struct {
	...
	// The minimum loki this node is required to reserve in its
	// balance.
	...
	// The minimum loki the other node is required to reserve in its
	// balance.
...
type PendingChannelsResponse_PendingOpenChannel struct {
	...
	// The required number of loki per kilo-weight that the requester will
...
type PendingChannelsResponse_WaitingCloseChannel struct {
	...
	Channel *PendingChannelsResponse_PendingChannel `protobuf:"bytes,1,opt,name=channel,proto3" json:"channel,omitempty"`
	// The balance in loki encumbered in this channel
...
type PendingChannelsResponse_Commitments struct {
	...
	// The amount in loki calculated to be paid in fees for the local
	// commitment.
	...
	// The amount in loki calculated to be paid in fees for the remote
	// commitment.
...
type PendingChannelsResponse_ForceClosedChannel struct {
	...
	// The transaction id of the closing transaction
	ClosingTxid string `protobuf:"bytes,2,opt,name=closing_txid,json=closingTxid,proto3" json:"closing_txid,omitempty"`
	// The balance in loki encumbered in this pending channel
...
var file_lightning_proto_rawDesc = []byte{
	...
	,
	...
	0x38, 0x01, 0x22, 0x5e, 0x0a, 0x17, 0x53, 0x65, 0x6e, 0x64, 0x4f, 0x6e, 0x69, 0x6f, 0x6e, 0x4d,
	...
	0x72, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x61, 0x74, 0x68, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x07, 0x70, 0x61, 0x74, 0x68, 0x4b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05,
	0x6f, 0x6e, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x6f, 0x6e, 0x69,
	0x6f, 0x6e, 0x22, 0x32, 0x0a, 0x18, 0x53, 0x65, 0x6e, 0x64, 0x4f, 0x6e, 0x69, 0x6f, 0x6e, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16,
	0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xe6, 0x01, 0x0a, 0x04, 0x55, 0x74, 0x78, 0x6f, 0x12,
	...
	,
	...
	0x6e, 0x64, 0x65, 0x78, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x24, 0x0a, 0x0e,
	0x69, 0x73, 0x5f, 0x6f, 0x75, 0x72, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x69, 0x73, 0x4f, 0x75, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x22, 0xce, 0x03, 0x0a, 0x0b, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69,
	...
	,
	...
	0x52, 0x11, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x4f, 0x75, 0x74, 0x70, 0x6f, 0x69,
	0x6e, 0x74, 0x73, 0x22, 0xc2, 0x01, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73,
	...
	0x09, 0x52, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x69, 0x6e,
	0x64, 0x65, 0x78, 0x5f, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x0b, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x4f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x12, 0x29, 0x0a,
	0x10, 0x6d, 0x61, 0x78, 0x5f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x6d, 0x61, 0x78, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x8c, 0x01, 0x0a, 0x12, 0x54, 0x72, 0x61,
	...
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x6c, 0x61, 0x73, 0x74, 0x5f,
	0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x6c, 0x61, 0x73,
	0x74, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x1f, 0x0a, 0x0b, 0x66, 0x69, 0x72, 0x73, 0x74, 0x5f,
	0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x66, 0x69, 0x72,
	0x73, 0x74, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x68, 0x0a, 0x08, 0x46, 0x65, 0x65, 0x4c, 0x69,
	...
	0x74, 0x22, 0xec, 0x04, 0x0a, 0x14, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x41, 0x63, 0x63,
	...
	,
	...
	0x22, 0x90, 0x03, 0x0a, 0x12, 0x45, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x65, 0x46, 0x65, 0x65,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x18, 0x05,
	...
	,
	...
	0x52, 0x0b, 0x73, 0x61, 0x74, 0x50, 0x65, 0x72, 0x56, 0x62, 0x79, 0x74, 0x65, 0x12, 0x27, 0x0a,
	0x06, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e,
	0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x4f, 0x75, 0x74, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x06,
	0x69, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x22, 0xc1, 0x03, 0x0a, 0x0f, 0x53, 0x65, 0x6e, 0x64, 0x4d,
	...
	0x08, 0x52, 0x10, 0x73, 0x70, 0x65, 0x6e, 0x64, 0x55, 0x6e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x72,
	0x6d, 0x65, 0x64, 0x12, 0x54, 0x0a, 0x17, 0x63, 0x6f, 0x69, 0x6e, 0x5f, 0x73, 0x65, 0x6c, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x18, 0x09,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x43, 0x6f, 0x69,
	0x6e, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65,
	0x67, 0x79, 0x52, 0x15, 0x63, 0x6f, 0x69, 0x6e, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x1a, 0x3f, 0x0a, 0x11, 0x41, 0x64, 0x64,
	...
	0x69, 0x64, 0x22, 0xa9, 0x03, 0x0a, 0x10, 0x53, 0x65, 0x6e, 0x64, 0x43, 0x6f, 0x69, 0x6e, 0x73,
	...
	0x2d, 0x0a, 0x09, 0x6f, 0x75, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x18, 0x0b, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x4f, 0x75, 0x74, 0x50, 0x6f,
	0x69, 0x6e, 0x74, 0x52, 0x09, 0x6f, 0x75, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x22, 0x27,
	...
	0x22, 0x2d, 0x0a, 0x13, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x50, 0x65, 0x65, 0x72, 0x52,
	...
	0x79, 0x22, 0x30, 0x0a, 0x16, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x50,
	0x65, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x22, 0xa3, 0x02, 0x0a, 0x04, 0x48, 0x54, 0x4c, 0x43, 0x12, 0x1a, 0x0a, 0x08,
	...
	0x69, 0x6e, 0x67, 0x48, 0x74, 0x6c, 0x63, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x1b, 0x0a, 0x09,
	0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x64, 0x5f, 0x69, 0x6e, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x08, 0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x64, 0x49, 0x6e, 0x22, 0x84, 0x02, 0x0a, 0x12, 0x43, 0x68,
	...
	0x61, 0x73, 0x4d, 0x61, 0x70, 0x73, 0x22, 0xe6, 0x06, 0x0a, 0x13, 0x43, 0x68, 0x61, 0x6e, 0x6e,
	...
	0x69, 0x64, 0x12, 0x2e, 0x0a, 0x13, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x63, 0x68, 0x61,
	0x6e, 0x6e, 0x65, 0x6c, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x10, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x11, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x44, 0x61,
	0x74, 0x61, 0x22, 0x8a, 0x01, 0x0a, 0x0b, 0x43, 0x6c, 0x6f, 0x73, 0x75, 0x72, 0x65, 0x54, 0x79,
	...
	0x28, 0x09, 0x52, 0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x22, 0x4d, 0x0a, 0x11, 0x43,
	...
	0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0x94, 0x01, 0x0a, 0x0b, 0x43,
	0x6c, 0x6f, 0x73, 0x65, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x6d,
	0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x73, 0x61, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09,
	...
	0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x6c, 0x6f, 0x63,
	0x61, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x4c, 0x6f, 0x63, 0x61,
	0x6c, 0x12, 0x2e, 0x0a, 0x13, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x63, 0x68, 0x61, 0x6e,
	0x6e, 0x65, 0x6c, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x11,
	0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x44, 0x61, 0x74,
	0x61, 0x22, 0x9a, 0x02, 0x0a, 0x12, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x43, 0x6c, 0x6f,
	...
	,
	...
	0x65, 0x72, 0x56, 0x62, 0x79, 0x74, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x6e, 0x6f, 0x5f, 0x77, 0x61,
	0x69, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x6e, 0x6f, 0x57, 0x61, 0x69, 0x74,
	0x22, 0xd3, 0x01, 0x0a, 0x11, 0x43, 0x6c, 0x6f, 0x73, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x74, 0x65, 0x48, 0x00, 0x52, 0x09, 0x63, 0x68, 0x61, 0x6e, 0x43, 0x6c, 0x6f, 0x73, 0x65, 0x12,
	0x3b, 0x0a, 0x0d, 0x63, 0x6c, 0x6f, 0x73, 0x65, 0x5f, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x74,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x49,
	0x6e, 0x73, 0x74, 0x61, 0x6e, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x48, 0x00, 0x52, 0x0c,
	0x63, 0x6c, 0x6f, 0x73, 0x65, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x74, 0x42, 0x08, 0x0a, 0x06,
	...
	0x61, 0x6c, 0x43, 0x6c, 0x6f, 0x73, 0x65, 0x54, 0x78, 0x22, 0x3b, 0x0a, 0x0d, 0x49, 0x6e, 0x73,
	0x74, 0x61, 0x6e, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x2a, 0x0a, 0x11, 0x6e, 0x75,
	0x6d, 0x5f, 0x70, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x68, 0x74, 0x6c, 0x63, 0x73, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0f, 0x6e, 0x75, 0x6d, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e,
	0x67, 0x48, 0x74, 0x6c, 0x63, 0x73, 0x22, 0x79, 0x0a, 0x13, 0x52, 0x65, 0x61, 0x64, 0x79, 0x46,
	...
	0x74, 0x22, 0xc9, 0x02, 0x0a, 0x17, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4f, 0x70, 0x65, 0x6e, 0x43,
	...
	0x52, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x12, 0x54, 0x0a, 0x17, 0x63, 0x6f, 0x69, 0x6e, 0x5f,
	0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x74, 0x72, 0x61, 0x74, 0x65,
	0x67, 0x79, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x22, 0x89, 0x06,
	...
	0x80, 0x15, 0x0a, 0x17, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x43, 0x68, 0x61, 0x6e, 0x6e,
	...
	0x1a, 0xe3, 0x04, 0x0a, 0x0e, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x43, 0x68, 0x61, 0x6e,
	...
	0x52, 0x04, 0x6d, 0x65, 0x6d, 0x6f, 0x12, 0x2e, 0x0a, 0x13, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	0x5f, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x22, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x11, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x43, 0x68, 0x61, 0x6e, 0x6e,
	0x65, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x1a, 0xe8, 0x02, 0x0a, 0x12, 0x50, 0x65, 0x6e, 0x64, 0x69,
	...
	,
	...
	0x6e, 0x74, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xeb,
	0x05, 0x0a, 0x12, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x55,
	...
	0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x4d, 0x0a, 0x17, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65,
	0x6c, 0x5f, 0x66, 0x75, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75,
	0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e,
	0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x48, 0x00, 0x52, 0x15,
	0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x46, 0x75, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x54, 0x69,
	0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x38, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20,
	...
	0xaf, 0x01, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x10,
	...
	0x45, 0x4c, 0x10, 0x05, 0x12, 0x1b, 0x0a, 0x17, 0x43, 0x48, 0x41, 0x4e, 0x4e, 0x45, 0x4c, 0x5f,
	0x46, 0x55, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x54, 0x49, 0x4d, 0x45, 0x4f, 0x55, 0x54, 0x10,
	0x06, 0x42, 0x09, 0x0a, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x22, 0x74, 0x0a, 0x14,
	...
	0x63, 0x65, 0x22, 0x4d, 0x0a, 0x14, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x42, 0x61, 0x6c, 0x61,
	...
	0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x6d, 0x69, 0x6e, 0x43, 0x6f, 0x6e, 0x66,
	0x73, 0x22, 0xbd, 0x03, 0x0a, 0x15, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x42, 0x61, 0x6c, 0x61,
	...
	0x6e, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xb0, 0x04, 0x0a, 0x16, 0x43,
	...
	0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x2e, 0x0a,
	0x13, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x5f,
	0x64, 0x61, 0x74, 0x61, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x11, 0x63, 0x75, 0x73, 0x74,
	0x6f, 0x6d, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x22, 0x9e, 0x07,
	...
	0x73, 0x12, 0x26, 0x0a, 0x0f, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x68, 0x6f, 0x70, 0x5f, 0x70, 0x75,
	...
	0x6e, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x14, 0x20, 0x03, 0x28, 0x04, 0x52, 0x0f, 0x6f, 0x75, 0x74,
	0x67, 0x6f, 0x69, 0x6e, 0x67, 0x43, 0x68, 0x61, 0x6e, 0x49, 0x64, 0x73, 0x1a, 0x44, 0x0a, 0x16,
	0x44, 0x65, 0x73, 0x74, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64,
	0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02,
	0x38, 0x01, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x0e, 0x10, 0x0f, 0x22, 0x2e,
	...
	0x50, 0x52, 0x4f, 0x4f, 0x54, 0x5f, 0x50, 0x55, 0x42, 0x4b, 0x45, 0x59, 0x10, 0x05, 0x2a, 0xd3,
	...
	0x44, 0x5f, 0x4c, 0x45, 0x41, 0x53, 0x45, 0x10, 0x04, 0x12, 0x0b, 0x0a, 0x07, 0x54, 0x41, 0x50,
	0x52, 0x4f, 0x4f, 0x54, 0x10, 0x07, 0x12, 0x18, 0x0a, 0x14, 0x53, 0x49, 0x4d, 0x50, 0x4c, 0x45,
	0x5f, 0x54, 0x41, 0x50, 0x52, 0x4f, 0x4f, 0x54, 0x5f, 0x46, 0x49, 0x4e, 0x41, 0x4c, 0x10, 0x07,
	...
	0x1a, 0x02, 0x10, 0x01, 0x2a, 0x61, 0x0a, 0x09, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x74, 0x6f,
	...
	0x63, 0x2e, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x30, 0x01, 0x12, 0x54, 0x0a, 0x15, 0x44,
	0x65, 0x6c, 0x65, 0x74, 0x65, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x65, 0x64, 0x49, 0x6e, 0x76,
	0x6f, 0x69, 0x63, 0x65, 0x12, 0x1c, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x44, 0x65, 0x6c,
	0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x65, 0x64, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x52,
	0x65, 0x71, 0x1a, 0x1d, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x44, 0x65, 0x6c, 0x43, 0x61,
	0x6e, 0x63, 0x65, 0x6c, 0x65, 0x64, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x12, 0x32, 0x0a, 0x0c, 0x44, 0x65, 0x63, 0x6f, 0x64, 0x65, 0x50, 0x61, 0x79, 0x52, 0x65,
	...
	,
	...
	0x1a, 0x19, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x4f, 0x6e, 0x69, 0x6f, 0x6e, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x30, 0x01, 0x12, 0x44, 0x0a,
	...
	0x6f, 0x6d, 0x2f, 0x66, 0x6c, 0x6f, 0x6b, 0x69, 0x6f, 0x72, 0x67, 0x2f, 0x66, 0x6c, 0x6e, 0x64,
...
var file_lightning_proto_msgTypes = make([]protoimpl.MessageInfo, 233)
var file_lightning_proto_goTypes = []interface{}{
	...
	(*DelCanceledInvoiceReq)(nil),                               // 166: lnrpc.DelCanceledInvoiceReq
	(*DelCanceledInvoiceResp)(nil),                              // 167: lnrpc.DelCanceledInvoiceResp
	...
	(*MetadataValues)(nil),                                      // 220: lnrpc.MetadataValues
	...
	nil,                                                         // 226: lnrpc.OnionMessageUpdate.CustomRecordsEntry
	...
	nil, // 253: lnrpc.RPCMiddlewareRequest.MetadataPairsEntry
}
var file_lightning_proto_depIdxs = []int32{
	154, // 0: lnrpc.OnionMessageUpdate.reply_path:type_name -> lnrpc.BlindedPath
	226, // 1: lnrpc.OnionMessageUpdate.custom_records:type_name -> lnrpc.OnionMessageUpdate.CustomRecordsEntry
	2,   // 2: lnrpc.Utxo.address_type:type_name -> lnrpc.AddressType
	40,  // 3: lnrpc.Utxo.outpoint:type_name -> lnrpc.OutPoint
	...
	227, // 9: lnrpc.EstimateFeeRequest.AddrToAmount:type_name -> lnrpc.EstimateFeeRequest.AddrToAmountEntry
	1,   // 10: lnrpc.EstimateFeeRequest.coin_selection_strategy:type_name -> lnrpc.CoinSelectionStrategy
	40,  // 11: lnrpc.EstimateFeeRequest.inputs:type_name -> lnrpc.OutPoint
	40,  // 12: lnrpc.EstimateFeeResponse.inputs:type_name -> lnrpc.OutPoint
	228, // 13: lnrpc.SendManyRequest.AddrToAmount:type_name -> lnrpc.SendManyRequest.AddrToAmountEntry
	...
	31,  // 17: lnrpc.ListUnspentResponse.utxos:type_name -> lnrpc.Utxo
	...
	229, // 35: lnrpc.Peer.features:type_name -> lnrpc.Peer.FeaturesEntry
	...
	85,  // 39: lnrpc.GetInfoResponse.chains:type_name -> lnrpc.Chain
	230, // 40: lnrpc.GetInfoResponse.features:type_name -> lnrpc.GetInfoResponse.FeaturesEntry
	231, // 41: lnrpc.GetDebugInfoResponse.config:type_name -> lnrpc.GetDebugInfoResponse.ConfigEntry
	...
	39,  // 46: lnrpc.CloseChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	...
	40,  // 56: lnrpc.OpenChannelRequest.outpoints:type_name -> lnrpc.OutPoint
	...
	39,  // 61: lnrpc.ChanPointShim.chan_point:type_name -> lnrpc.ChannelPoint
	...
	233, // 69: lnrpc.PendingChannelsResponse.pending_open_channels:type_name -> lnrpc.PendingChannelsResponse.PendingOpenChannel
	236, // 70: lnrpc.PendingChannelsResponse.pending_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ClosedChannel
	237, // 71: lnrpc.PendingChannelsResponse.pending_force_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel
	234, // 72: lnrpc.PendingChannelsResponse.waiting_close_channels:type_name -> lnrpc.PendingChannelsResponse.WaitingCloseChannel
	63,  // 73: lnrpc.ChannelEventUpdate.open_channel:type_name -> lnrpc.Channel
	69,  // 74: lnrpc.ChannelEventUpdate.closed_channel:type_name -> lnrpc.ChannelCloseSummary
	39,  // 75: lnrpc.ChannelEventUpdate.active_channel:type_name -> lnrpc.ChannelPoint
	39,  // 76: lnrpc.ChannelEventUpdate.inactive_channel:type_name -> lnrpc.ChannelPoint
	91,  // 77: lnrpc.ChannelEventUpdate.pending_open_channel:type_name -> lnrpc.PendingUpdate
	39,  // 78: lnrpc.ChannelEventUpdate.fully_resolved_channel:type_name -> lnrpc.ChannelPoint
	39,  // 79: lnrpc.ChannelEventUpdate.channel_funding_timeout:type_name -> lnrpc.ChannelPoint
	...
	245, // 113: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	...
	246, // 118: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	39,  // 119: lnrpc.ChannelEdgeUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	132, // 120: lnrpc.ChannelEdgeUpdate.routing_policy:type_name -> lnrpc.RoutingPolicy
	39,  // 121: lnrpc.ClosedChannelUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	...
	247, // 130: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	248, // 131: lnrpc.Invoice.amp_invoice_state:type_name -> lnrpc.Invoice.AmpInvoiceStateEntry
	...
	249, // 134: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	...
	169, // 138: lnrpc.Payment.htlcs:type_name -> lnrpc.HTLCAttempt
	9,   // 139: lnrpc.Payment.failure_reason:type_name -> lnrpc.PaymentFailureReason
	250, // 140: lnrpc.Payment.first_hop_custom_records:type_name -> lnrpc.Payment.FirstHopCustomRecordsEntry
	...
	213, // 143: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	168, // 144: lnrpc.ListPaymentsResponse.payments:type_name -> lnrpc.Payment
	39,  // 145: lnrpc.AbandonChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	152, // 146: lnrpc.PayReq.route_hints:type_name -> lnrpc.RouteHint
	251, // 147: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	153, // 148: lnrpc.PayReq.blinded_paths:type_name -> lnrpc.BlindedPaymentPath
	184, // 149: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	39,  // 150: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	186, // 151: lnrpc.PolicyUpdateRequest.inbound_fee:type_name -> lnrpc.InboundFee
	40,  // 152: lnrpc.FailedUpdate.outpoint:type_name -> lnrpc.OutPoint
	11,  // 153: lnrpc.FailedUpdate.reason:type_name -> lnrpc.UpdateFailure
	188, // 154: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	191, // 155: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	39,  // 156: lnrpc.ExportChannelBackupRequest.chan_point:type_name -> lnrpc.ChannelPoint
	39,  // 157: lnrpc.ChannelBackup.chan_point:type_name -> lnrpc.ChannelPoint
	39,  // 158: lnrpc.MultiChanBackup.chan_points:type_name -> lnrpc.ChannelPoint
	198, // 159: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	195, // 160: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	194, // 161: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	198, // 162: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	203, // 163: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	203, // 164: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	252, // 165: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	20,  // 166: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	214, // 167: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	216, // 168: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	203, // 169: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	221, // 170: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	222, // 171: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	222, // 172: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	253, // 173: lnrpc.RPCMiddlewareRequest.metadata_pairs:type_name -> lnrpc.RPCMiddlewareRequest.MetadataPairsEntry
	224, // 174: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	225, // 175: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	182, // 176: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	182, // 177: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	232, // 180: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	232, // 181: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	235, // 182: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	232, // 183: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	232, // 184: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	...
	182, // 188: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	139, // 189: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	182, // 190: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	182, // 191: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	156, // 192: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	182, // 193: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	210, // 194: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	220, // 195: lnrpc.RPCMiddlewareRequest.MetadataPairsEntry.value:type_name -> lnrpc.MetadataValues
	...
	34,  // 198: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	43,  // 199: lnrpc.Lightning.EstimateFee:input_type -> lnrpc.EstimateFeeRequest
	47,  // 200: lnrpc.Lightning.SendCoins:input_type -> lnrpc.SendCoinsRequest
	49,  // 201: lnrpc.Lightning.ListUnspent:input_type -> lnrpc.ListUnspentRequest
	34,  // 202: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	45,  // 203: lnrpc.Lightning.SendMany:input_type -> lnrpc.SendManyRequest
	51,  // 204: lnrpc.Lightning.NewAddress:input_type -> lnrpc.NewAddressRequest
	53,  // 205: lnrpc.Lightning.SignMessage:input_type -> lnrpc.SignMessageRequest
	55,  // 206: lnrpc.Lightning.VerifyMessage:input_type -> lnrpc.VerifyMessageRequest
	57,  // 207: lnrpc.Lightning.ConnectPeer:input_type -> lnrpc.ConnectPeerRequest
	59,  // 208: lnrpc.Lightning.DisconnectPeer:input_type -> lnrpc.DisconnectPeerRequest
	75,  // 209: lnrpc.Lightning.ListPeers:input_type -> lnrpc.ListPeersRequest
	77,  // 210: lnrpc.Lightning.SubscribePeerEvents:input_type -> lnrpc.PeerEventSubscription
	79,  // 211: lnrpc.Lightning.GetInfo:input_type -> lnrpc.GetInfoRequest
	81,  // 212: lnrpc.Lightning.GetDebugInfo:input_type -> lnrpc.GetDebugInfoRequest
	83,  // 213: lnrpc.Lightning.GetRecoveryInfo:input_type -> lnrpc.GetRecoveryInfoRequest
	110, // 214: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	64,  // 215: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	112, // 216: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	71,  // 217: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	...
	38,  // 222: lnrpc.Lightning.ChannelAcceptor:input_type -> lnrpc.ChannelAcceptResponse
	89,  // 223: lnrpc.Lightning.CloseChannel:input_type -> lnrpc.CloseChannelRequest
	176, // 224: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	157, // 225: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	163, // 226: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	162, // 227: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	165, // 228: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	166, // 229: lnrpc.Lightning.DeleteCanceledInvoice:input_type -> lnrpc.DelCanceledInvoiceReq
	180, // 230: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	170, // 231: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	172, // 232: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	173, // 233: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	135, // 234: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	137, // 235: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	140, // 236: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	...
	141, // 239: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	143, // 240: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	145, // 241: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	178, // 242: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	183, // 243: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	187, // 244: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	190, // 245: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	193, // 246: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	196, // 247: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	197, // 248: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	199, // 249: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	201, // 250: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	204, // 251: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	206, // 252: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	208, // 253: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	211, // 254: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	217, // 255: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	223, // 256: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	...
	29,  // 259: lnrpc.Lightning.SendOnionMessage:input_type -> lnrpc.SendOnionMessageRequest
	27,  // 260: lnrpc.Lightning.SubscribeOnionMessages:input_type -> lnrpc.SubscribeOnionMessagesRequest
	67,  // 261: lnrpc.Lightning.ListAliases:input_type -> lnrpc.ListAliasesRequest
	...
	35,  // 265: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	44,  // 266: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	48,  // 267: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	50,  // 268: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	33,  // 269: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	46,  // 270: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	52,  // 271: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	54,  // 272: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	56,  // 273: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	58,  // 274: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	60,  // 275: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	76,  // 276: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	78,  // 277: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	80,  // 278: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	82,  // 279: lnrpc.Lightning.GetDebugInfo:output_type -> lnrpc.GetDebugInfoResponse
	84,  // 280: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	111, // 281: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	65,  // 282: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	113, // 283: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	72,  // 284: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	39,  // 285: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	...
	37,  // 289: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	90,  // 290: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	177, // 291: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	161, // 292: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	164, // 293: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	157, // 294: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	157, // 295: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	167, // 296: lnrpc.Lightning.DeleteCanceledInvoice:output_type -> lnrpc.DelCanceledInvoiceResp
	181, // 297: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	171, // 298: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	174, // 299: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	175, // 300: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	136, // 301: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	138, // 302: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	134, // 303: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	129, // 304: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	123, // 305: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	142, // 306: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	144, // 307: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	146, // 308: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	179, // 309: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	185, // 310: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	189, // 311: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	192, // 312: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	194, // 313: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	197, // 314: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	202, // 315: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	200, // 316: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	197, // 317: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	205, // 318: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	207, // 319: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	209, // 320: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	212, // 321: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	218, // 322: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	219, // 323: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	26,  // 324: lnrpc.Lightning.SendCustomMessage:output_type -> lnrpc.SendCustomMessageResponse
	24,  // 325: lnrpc.Lightning.SubscribeCustomMessages:output_type -> lnrpc.CustomMessage
	30,  // 326: lnrpc.Lightning.SendOnionMessage:output_type -> lnrpc.SendOnionMessageResponse
	28,  // 327: lnrpc.Lightning.SubscribeOnionMessages:output_type -> lnrpc.OnionMessageUpdate
	68,  // 328: lnrpc.Lightning.ListAliases:output_type -> lnrpc.ListAliasesResponse
	22,  // 329: lnrpc.Lightning.LookupHtlcResolution:output_type -> lnrpc.LookupHtlcResolutionResponse
	263, // [263:330] is the sub-list for method output_type
	196, // [196:263] is the sub-list for method input_type
...
func file_lightning_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_lightning_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OnionMessageUpdate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
