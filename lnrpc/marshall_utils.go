...
// CalculateFeeLimit returns the fee limit in milliloki. If a percentage
...
func CalculateFeeLimit(feeLimit *FeeLimit,
	...
	case *FeeLimit_Fixed:
		return lnwire.NewMSatFromLokis(
...
func UnmarshallAmt(amtSat, amtMsat int64) (lnwire.MilliLoki, error) {
	...
	if amtSat != 0 {
		return lnwire.NewMSatFromLokis(chainutil.Amount(amtSat)), nil
	}
