...
description):
  ...
  * WalletBalance
     * Returns the wallet's current confirmed balance in FLC.
  * ChannelBalance
     * Returns the daemons' available aggregate channel balance in FLC.
  * GetTransactions
     * Returns a list of on-chain transactions that pay to or are spends from
       `lnd`.
  * SendCoins
     * Sends an amount of loki to a specific address.
  * ListUnspent
