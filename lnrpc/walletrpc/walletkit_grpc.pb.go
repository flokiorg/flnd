...
type WalletKitClient interface {
	...
	// RequiredReserve returns the minimum amount of loki that should be kept
	...
	// btcd implementation. Flokicoin-core's algorithm is not specified in a
	...
	// SendOutputs is similar to the existing sendmany call in Flokicoind, and
