...
type RoutingConfig struct {
	...
	AttemptCost chainutil.Amount `long:"attemptcost" description:"The fixed (virtual) cost in loki of a failed payment attempt"`
	...
	AttemptCostPPM int64 `long:"attemptcostppm" description:"The proportional (virtual) cost in loki of a failed payment attempt expressed in parts per million of the total payment amount"`
