...
const (
	// CoinTypeFlokicoin specifies the BIP44 coin type for Flokicoin key
	// derivation.
	CoinTypeFlokicoin uint32 = 0
...
func (b *BtcWalletKeyRing) ECDH(keyDesc KeyDescriptor,
	pub *crypto.PublicKey) ([32]byte, error) {
	...
	crypto.ScalarMultNonConst(&privKey.Key, &pubJacobian, &s)
	s.ToAffine()
