...
func (p *PubKeyECDH) PubKey() *crypto.PublicKey {
...
//
// NOTE: This is part of the SingleKeyECDH interface.
func (p *PubKeyECDH) ECDH(pubKey *crypto.PublicKey) ([32]byte, error) {
...
//
// NOTE: This is part of the SingleKeyECDH interface.
func (p *PrivKeyECDH) PubKey() *crypto.PublicKey {
...
//
// NOTE: This is part of the SingleKeyECDH interface.
func (p *PrivKeyECDH) ECDH(pub *crypto.PublicKey) ([32]byte, error) {
	var (
		pubJacobian crypto.JacobianPoint
		s           crypto.JacobianPoint
	)
	pub.AsJacobian(&pubJacobian)

	crypto.ScalarMultNonConst(&p.PrivKey.Key, &pubJacobian, &s)
	s.ToAffine()
	sPubKey := crypto.NewPublicKey(&s.X, &s.Y)
