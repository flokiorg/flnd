...
func testMultiHopPayments(ht *lntest.HarnessTest) {
	...
	updateChannelPolicy(
		...
		chainreg.DefaultFlokicoinTimeLockDelta, maxHtlc, carol,
	)
	...
	updateChannelPolicy(
		...
		chainreg.DefaultFlokicoinTimeLockDelta, maxHtlc,
		dave,
	)
	...
	// shifted by 5k loki in the direction of Bob, the sink within the
