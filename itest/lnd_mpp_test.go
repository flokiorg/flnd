...
type mppOpenChannelRequest struct {
	// Channel Alice=>Carol.
	amtAliceCarol chainutil.Amount

	// Channel Alice=>Dave.
	amtAliceDave chainutil.Amount

	// Channel Carol=>Bob.
	amtCarolBob chainutil.Amount

	// Channel Carol=>Eve.
	amtCarolEve chainutil.Amount

	// Channel Dave=>Bob.
	amtDaveBob chainutil.Amount

	// Channel Eve=>Bob.
	amtEveBob chainutil.Amount
}
...
func (m *mppTestScenario) buildRoute(amt chainutil.Amount,
