...
func testWumboChannels(ht *lntest.HarnessTest) {
	...
	// the channel funding.
	ht.FundCoins(chainutil.LokiPerFlokicoin, wumboNode)
	...
	chanAmt := funding.MaxFlokicoinFundingAmount + 1
	...
	ht.OpenChannelAssertErr(
		...
		lnwallet.ErrChanTooLarge(chanAmt, funding.MaxFlokicoinFundingAmount),
	)
