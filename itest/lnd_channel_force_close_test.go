...
const pushAmt = chainutil.Amount(5e5)
...
func runChannelForceClosureTest(ht *lntest.HarnessTest,
	...
	carolExpectedBalance := chainutil.Amount(carolStartingBalance) +
		pushAmt - totalFeeCarol

	require.Equal(ht, carolExpectedBalance,
		chainutil.Amount(carolBalResp.ConfirmedBalance),
