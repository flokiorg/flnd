...
func testZeroConfChannelOpen(ht *lntest.HarnessTest) {
	...
	chanAmt := chainutil.Amount(1_000_000)
	...
	// Open a private zero-conf anchors channel of 1M loki.
	...
	// We'll open a public zero-conf anchors channel of 1M loki.
...
func testZeroConfReorg(ht *lntest.HarnessTest) {
	...
	// Open a private zero-conf anchors channel of 1M loki.
	params := lntest.OpenChannelParams{
		Amt:            chainutil.Amount(1_000_000),
		CommitmentType: lnrpc.CommitmentType_ANCHORS,
		ZeroConf:       true,
	}
