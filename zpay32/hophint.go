...
type HopHint struct {
	...
	// FeeBaseMSat is the base fee of the channel in MilliLokis.
	FeeBaseMSat uint32
...
func (h HopHint) HopFee(amt lnwire.MilliLoki) lnwire.MilliLoki {
	baseFee := lnwire.MilliLoki(h.FeeBaseMSat)
	feeRate := lnwire.MilliLoki(h.FeeProportionalMillionths)
