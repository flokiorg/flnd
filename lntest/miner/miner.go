...
// asserts.
func (h *HarnessMiner) GetRawTransaction(txid chainhash.Hash) *chainutil.Tx {
...
func (h *HarnessMiner) GetRawTransactionVerbose(
	txid chainhash.Hash) *chainjson.TxRawResult {
...
func (h *HarnessMiner) SendOutputsWithoutChange(outputs []*wire.TxOut,
	feeRate chainutil.Amount) *chainhash.Hash {
...
func (h *HarnessMiner) CreateTransaction(outputs []*wire.TxOut,
	feeRate chainutil.Amount) *wire.MsgTx {
...
func (h *HarnessMiner) NewMinerAddress() chainutil.Address {
...
// transactions only.
func (h *HarnessMiner) MineBlockWithTxes(txes []*chainutil.Tx) *wire.MsgBlock {
...
func (h *HarnessMiner) MineBlockWithTx(tx *wire.MsgTx) *wire.MsgBlock {
	...
	txes := []*chainutil.Tx{chainutil.NewTx(tx)}
...
func (h *HarnessMiner) SpawnTempMiner() *HarnessMiner {
	...
	err := h.Client.Node(chainjson.NConnect, tempMiner.P2PAddress(), &Temp)
	...
	err = h.Client.Node(chainjson.NDisconnect, tempMiner.P2PAddress(), &Temp)
