...
// NewFlokicoindBackend spawns a new bitcoind node that connects to a miner at the
...
func NewFlokicoindBackend(t *testing.T, netParams *chaincfg.Params,
	miner *rpctest.Harness, txindex, rpcpolling bool) *chain.LokidConn {

	t.Helper()

	tempFlokicoindDir := t.TempDir()
	...
	syncFlokicoindWithMiner(t, rpcClient, miner, p2pPort)
...
// syncFlokicoindWithMiner waits until the bitcoind node is synced with the miner.
func syncFlokicoindWithMiner(t *testing.T, notifier *rpcclient.Client,
