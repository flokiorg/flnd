...
import (
	...
	"github.com/flokiorg/flnd/lntest/port"
...
// FlokicoindBackendConfig is an implementation of the BackendConfig interface
// backed by a Flokicoind node.
type FlokicoindBackendConfig struct {
	rpcHost      string
	rpcUser      string
	rpcPass      string
	zmqBlockPath string
...
// A compile time assertion to ensure FlokicoindBackendConfig meets the
// BackendConfig interface.
var _ node.BackendConfig = (*FlokicoindBackendConfig)(nil)

// GenArgs returns the arguments needed to be passed to LND at startup for
// using this node as a chain backend.
func (b FlokicoindBackendConfig) GenArgs() []string {
	var args []string
...
func (b FlokicoindBackendConfig) ConnectMiner() error {
	return b.rpcClient.AddNode(b.minerAddr, rpcclient.ANAdd)
}

// DisconnectMiner is called to disconnect the miner.
func (b FlokicoindBackendConfig) DisconnectMiner() error {
...
func (b FlokicoindBackendConfig) Credentials() (string, string, string, error) {
	return b.rpcUser, b.rpcPass, b.rpcHost, nil
}

// Name returns the name of the backend type.
func (b FlokicoindBackendConfig) Name() string {
	return "bitcoind"
}

// P2PAddr return bitcoin p2p ip:port.
func (b FlokicoindBackendConfig) P2PAddr() (string, error) {
...
// a FlokicoindBackendConfig for that node.
func newBackend(miner string, netParams *chaincfg.Params, extraArgs []string,
	rpcPolling bool) (*FlokicoindBackendConfig, func() error, error) {
	...
	tempFlokicoindDir, err := os.MkdirTemp("", "bitcoind")
	if err != nil {
		return nil, nil,
	...
	err = bitcoind.Start()
	if err != nil {
		if err := os.RemoveAll(tempFlokicoindDir); err != nil {
			fmt.Printf("unable to remote temp dir %v: %v",
				tempFlokicoindDir, err)
		}
