...
func (d *DummySignature) Verify(_ []byte, _ *crypto.PublicKey) bool {
	return true
}
...
func (d *DummySigner) MuSig2CreateSession(input.MuSig2Version,
	keychain.KeyLocator, []*crypto.PublicKey, *input.MuSig2Tweaks,
...
func NewSingleSigner(privkey *crypto.PrivateKey) *SingleSigner {
	signer := &SingleSigner{
		Privkey: privkey,
		KeyLoc:  idKeyLoc,
	}
