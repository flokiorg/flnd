...
const (
	...
	DefaultBitcoinMinHTLCInMSat = lnwire.MilliLoki(1)
	...
	DefaultBitcoinMinHTLCOutMSat = lnwire.MilliLoki(1000)

	// DefaultBitcoinBaseFeeMSat is the default forwarding base fee.
	DefaultBitcoinBaseFeeMSat = lnwire.MilliLoki(1000)

	// DefaultBitcoinFeeRate is the default forwarding fee rate.
	DefaultBitcoinFeeRate = lnwire.MilliLoki(1)
...
var (
	// FlokicoinTestnetGenesis is the genesis hash of Bitcoin's testnet
	// chain.
	FlokicoinTestnetGenesis = *chaincfg.TestNet3Params.GenesisHash

	// Flokicoinestnet4Genesis is the genesis hash of Bitcoin's testnet4
	// chain.
	FlokicoinTestnet4Genesis = *chaincfg.TestNet4Params.GenesisHash

	// FlokicoinSignetGenesis is the genesis hash of Bitcoin's signet chain.
