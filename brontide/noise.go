...
const (
	...
	// exact same string for this value, along with prologue of the Flokicoin
...
var (
	...
	ephemeralGen = func() (*crypto.PrivateKey, error) {
...
func ecdh(pub *crypto.PublicKey, priv keychain.SingleKeyECDH) ([]byte, error) {
...
func newHandshakeState(initiator bool, prologue []byte,
	...
	remotePub *crypto.PublicKey) handshakeState {
...
func EphemeralGenerator(gen func() (*crypto.PrivateKey, error)) func(*Machine) {
...
func NewBrontideMachine(initiator bool, localKey keychain.SingleKeyECDH,
	remotePub *crypto.PublicKey, options ...func(*Machine)) *Machine {
...
func (b *Machine) RecvActOne(actOne [ActOneSize]byte) error {
	...
	// e
	b.remoteEphemeral, err = crypto.ParsePubKey(e[:])
	if err != nil {
		return err
	}
...
func (b *Machine) RecvActThree(actThree [ActThreeSize]byte) error {
	...
	b.remoteStatic, err = crypto.ParsePubKey(remotePub)
	if err != nil {
		return err
	}
