...
type Listener struct {
	...
	shouldAccept func(*crypto.PublicKey) (bool, error)
...
func NewListener(localStatic keychain.SingleKeyECDH, listenAddr string,
	shouldAccept func(*crypto.PublicKey) (bool, error)) (*Listener, error) {
...
// the ban-scoring.
func DisabledBanClosure(p *crypto.PublicKey) (bool, error) {
	return true, nil
}
