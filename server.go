...
func newServer(cfg *Config, listenAddrs []net.Addr,
	...
	thresholdMSats := lnwire.NewMLokFromLokis(thresholdSats)
	...
	pathFindingConfig := routing.PathFindingConfig{
		AttemptCost: lnwire.NewMLokFromLokis(
	...
	s.fundingMgr, err = funding.NewFundingManager(funding.Config{
		...
		NumRequiredConfs: func(chanAmt chainutil.Amount,
			...
			maxChannelSize := uint64(
				lnwire.NewMLokFromLokis(MaxFundingAmount))
			stake := lnwire.NewMLokFromLokis(chanAmt) + pushAmt
...
func (s *server) notifyPendingOpenChannelPeerEvent(op wire.OutPoint,
	pendingChan *channeldb.OpenChannel, remotePub *crypto.PublicKey) error {
...
func (s *server) fetchNodeAdvertisedAddrs(pub *crypto.PublicKey) ([]net.Addr, error) {
