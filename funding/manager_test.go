...
func createTestFundingManager(t *testing.T, privKey *crypto.PrivateKey,
	...
	fundingCfg := Config{
		...
		RequiredRemoteMaxValue: func(chanAmt chainutil.Amount) lnwire.MilliLoki {
			reserve := lnwire.NewMLokFromLokis(chanAmt / 100)
			return lnwire.NewMLokFromLokis(chanAmt) - reserve
		},
...
func fundChannel(t *testing.T, alice, bob *testNode, localFundingAmt,
	...
	initReq := &InitFundingMsg{
		...
		PushAmt:         lnwire.NewMLokFromLokis(pushAmt),
...
func TestFundingManagerPeerTimeoutAfterInitFunding(t *testing.T) {
	...
	initReq := &InitFundingMsg{
		...
		PushAmt:         lnwire.NewMLokFromLokis(0),
		Private:         false,
		Updates:         updateChan,
		Err:             errChan,
	}
...
func TestFundingManagerCustomChannelParameters(t *testing.T) {
	...
	reserve := lnwire.NewMLokFromLokis(fundingAmt / 100)
	maxValueAcceptChannel := lnwire.NewMLokFromLokis(fundingAmt) - reserve
...
func TestFundingManagerInvalidChanReserve(t *testing.T) {
	...
	var (
		...
		pushAmt     = lnwire.NewMLokFromLokis(10)
...
func testUpfrontFailure(t *testing.T, pkscript []byte, expectErr bool) {
	...
	fundingAmt := chainutil.Amount(500000)
	pushAmt := lnwire.NewMLokFromLokis(chainutil.Amount(0))
