...
type Config struct {
	...
	NotifyOpenChannelEvent func(wire.OutPoint, *crypto.PublicKey) error
	...
	NotifyPendingOpenChannelEvent func(wire.OutPoint,
		*channeldb.OpenChannel, *crypto.PublicKey) error
	...
	// zero-conf.
	NotifyFundingTimeout func(wire.OutPoint, *crypto.PublicKey) error
...
func (f *Manager) extractAnnounceParams(c *channeldb.OpenChannel) (
	...
	capacityMSat := lnwire.NewMLokFromLokis(c.Capacity)
