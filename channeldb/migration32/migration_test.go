...
var (
	...
	resultNew1Hop1 = &mcHop{
		...
		amtToFwd:    tlv.NewPrimitiveRecord[tlv.TlvType2, lnwire.MilliLoki](500),
	...
	resultNew1Hop2 = &mcHop{
		...
		pubKeyBytes: tlv.NewRecordT[tlv.TlvType1](testPub),
		amtToFwd:    tlv.NewPrimitiveRecord[tlv.TlvType2, lnwire.MilliLoki](4),
	}
	...
	resultNew1 = paymentResultNew{
		...
		route: tlv.NewRecordT[tlv.TlvType2](mcRoute{
			...
			totalAmount:  tlv.NewRecordT[tlv.TlvType1, lnwire.MilliLoki](400),
	...
	resultNew2 = paymentResultNew{
		...
		route: tlv.NewRecordT[tlv.TlvType2](mcRoute{
			...
			totalAmount:  tlv.NewRecordT[tlv.TlvType1, lnwire.MilliLoki](401),
