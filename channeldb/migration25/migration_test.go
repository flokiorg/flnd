...
import (
	...
	mig24 "github.com/flokiorg/flnd/channeldb/migration24"
	mig "github.com/flokiorg/flnd/channeldb/migration_01_to_11"
	"github.com/flokiorg/flnd/channeldb/migtest"
...
var (
	...
	dummyPrivKey, _ = crypto.NewPrivateKey()
	...
	ourAmt   = lnwire.MilliLoki(500_000)
	theirAmt = lnwire.MilliLoki(1000_000)
	...
	ourAmtRevoke   = lnwire.MilliLoki(501_000)
	theirAmtRevoke = lnwire.MilliLoki(1001_000)
	...
	remoteCommit0 = mig.ChannelCommitment{
		...
		CommitFee:     chainutil.Amount(1),
		FeePerKw:      chainutil.Amount(1),
		CommitTx:      dummyTx,
		CommitSig:     dummySig,
		Htlcs:         []mig.HTLC{},
	}
...
func genAfterMigration(ourAmt, theirAmt lnwire.MilliLoki,
