...
import (
	...
	"github.com/flokiorg/flnd/channeldb/migration21/common"
	"github.com/flokiorg/flnd/channeldb/migration21/current"
	"github.com/flokiorg/flnd/channeldb/migration21/legacy"
...
var (
	...
	_, pubKey = crypto.PrivKeyFromBytes(key[:])
