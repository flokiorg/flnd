...
type ClosingSigned struct {
	...
	// FeeLokis is the total fee in loki that the party to the
...
func NewClosingSigned(cid ChannelID, fs chainutil.Amount,
...
func (c *ClosingSigned) Decode(r io.Reader, pver uint32) error {
	return ReadElements(r, &c.ChannelID, &c.FeeLokis, &c.Signature)
}
...
func (c *ClosingSigned) Encode(w io.Writer, pver uint32) error {
	return WriteElements(w, c.ChannelID, c.FeeLokis, c.Signature)
}
