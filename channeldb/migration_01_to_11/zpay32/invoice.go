...
const (
	// mSatPerBtc is the number of MilliLokis in 1 BTC.
...
type Invoice struct {
	...
	// MilliSat specifies the amount of this invoice in MilliLoki.
	// Optional.
	MilliSat *lnwire.MilliLoki
	...
	// Optional.
	FallbackAddr chainutil.Address
...
// amount in MilliLokis that the Invoice should encode.
func Amount(milliSat lnwire.MilliLoki) func(*Invoice) {
...
func Destination(destination *crypto.PublicKey) func(*Invoice) {
	return func(i *Invoice) {
...
func FallbackAddr(fallbackAddr chainutil.Address) func(*Invoice) {
	return func(i *Invoice) {
