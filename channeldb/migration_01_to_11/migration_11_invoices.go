...
import (
	...
	"github.com/flokiorg/flnd/channeldb/migration_01_to_11/zpay32"
	"github.com/flokiorg/flnd/kvdb"
	bitcoinCfg "github.com/flokiorg/go-flokicoin/chaincfg"
...
func deserializeInvoiceLegacy(r io.Reader) (Invoice, error) {
	...
	invoice.Terms.Value = lnwire.MilliLoki(byteOrder.Uint64(scratch[:]))
