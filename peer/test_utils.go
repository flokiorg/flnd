...
func createTestPeerWithChannel(t *testing.T, updateChan func(a,
	...
	channelCapacity := chainutil.Amount(10 * 1e8)
...
func (m *mockUpdateHandler) Bandwidth() lnwire.MilliLoki { return 0 }
...
func (m *mockUpdateHandler) MayAddOutgoingHtlc(lnwire.MilliLoki) error { return nil }
...
func createTestPeer(t *testing.T) *peerTestCtx {
	...
	serverKey, err := crypto.NewPrivateKey()
	require.NoError(t, err)
	...
	cfg := &Config{
		...
		DisconnectPeer: func(b *crypto.PublicKey) error {
			return nil
		},
