...
type MessageSender interface {
	...
	// pointer otherwise
	SendMessages(crypto.PublicKey, []lnwire.Message) error
}
...
func newPeerMsgSender(peerPub crypto.PublicKey,
...
// otherwise?
func (p *peerMsgSender) SendMessages(pub crypto.PublicKey,
...
// SendMessages sends the target set of messages to the target peer.
func (l *LndDaemonAdapters) SendMessages(pub crypto.PublicKey,
	msgs []lnwire.Message) error {
