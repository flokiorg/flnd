...
type DynPropose struct {
	...
	ChannelReserve tlv.OptionalRecordT[
		tlv.TlvType6, tlv.BigSizeT[chainutil.Amount],
	]
...
func (dp *DynPropose) Decode(r io.Reader, _ uint32) error {
	...
	var dustLimit tlv.RecordT[tlv.TlvType0, tlv.BigSizeT[chainutil.Amount]]
	var maxValue tlv.RecordT[tlv.TlvType2, MilliLoki]
	var htlcMin tlv.RecordT[tlv.TlvType4, MilliLoki]
	var reserve tlv.RecordT[tlv.TlvType6, tlv.BigSizeT[chainutil.Amount]]
