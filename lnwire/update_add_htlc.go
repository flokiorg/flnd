...
type (
	...
	// htlc.
	//nolint:ll
	BlindingPointRecord = tlv.OptionalRecordT[BlindingPointTlvType, *crypto.PublicKey]
)
...
type UpdateAddHTLC struct {
	...
	// Amount is the amount of MilliLokis this HTLC is worth.
	Amount MilliLoki
...
func (c *UpdateAddHTLC) Encode(w *bytes.Buffer, pver uint32) error {
	...
	if err := WriteMilliLoki(w, c.Amount); err != nil {
		return err
	}
	...
	c.BlindingPoint.WhenSome(
		func(b tlv.RecordT[BlindingPointTlvType, *crypto.PublicKey]) {
