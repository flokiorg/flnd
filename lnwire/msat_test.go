...
func TestMilliLokiConversion(t *testing.T) {
	t.Parallel()

	testCases := []struct {
		mSatAmount MilliLoki

		satAmount chainutil.Amount
		btcAmount float64
	}{
		{
			mSatAmount: 0,
