...
func (a *ChannelUpdate1) Encode(w *bytes.Buffer, pver uint32) error {
	...
	if err := WriteMilliLoki(w, a.HtlcMinimumMsat); err != nil {
		return err
	}
	...
	if a.MessageFlags.HasMaxHtlc() {
		err := WriteMilliLoki(w, a.HtlcMaximumMsat)
		if err != nil {
			return err
		}
	}
...
func (a *ChannelUpdate1) DataToSign() ([]byte, error) {
	...
	if err := WriteMilliLoki(buf, a.HtlcMinimumMsat); err != nil {
		return nil, err
	}
	...
	// optional field is max HTLC.
	if a.MessageFlags.HasMaxHtlc() {
		err := WriteMilliLoki(buf, a.HtlcMaximumMsat)
		if err != nil {
			return nil, err
		}
	}
...
func (a *ChannelUpdate1) ForwardingPolicy() *ForwardingPolicy {
	return &ForwardingPolicy{
		...
		BaseFee:       MilliLoki(a.BaseFee),
		FeeRate:       MilliLoki(a.FeeRate),
