...
func NewFailIncorrectDetails(amt MilliLoki,
...
// Amount is the value of the extended HTLC.
func (f *FailIncorrectDetails) Amount() MilliLoki {
	return f.amount
}
...
func (f *FailIncorrectDetails) Encode(w *bytes.Buffer, pver uint32) error {
	if err := WriteMilliLoki(w, f.amount); err != nil {
		return err
	}
...
func NewAmountBelowMinimum(htlcMsat MilliLoki,
...
func (f *FailAmountBelowMinimum) Encode(w *bytes.Buffer, pver uint32) error {
	if err := WriteMilliLoki(w, f.HtlcMsat); err != nil {
		return err
	}
...
func NewFeeInsufficient(htlcMsat MilliLoki,
...
func NewFinalIncorrectHtlcAmount(amount MilliLoki) *FailFinalIncorrectHtlcAmount {
...
func (f *FailFinalIncorrectHtlcAmount) Encode(w *bytes.Buffer,
	...
	return WriteMilliLoki(w, f.IncomingHTLCAmount)
}
