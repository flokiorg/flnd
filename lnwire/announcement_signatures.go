...
type AnnounceSignatures1 struct {
	...
	// FlokicoinSignature is the signature which contains the signed node
...
func (a *AnnounceSignatures1) Encode(w *bytes.Buffer, _ uint32) error {
	...
	if err := WriteSig(w, a.FlokicoinSignature); err != nil {
		return err
	}
