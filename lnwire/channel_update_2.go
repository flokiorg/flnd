...
const (
	...
	defaultHtlcMinMsat               = MilliLoki(1)
...
type ChannelUpdate2 struct {
	...
	HTLCMinimumMsat tlv.RecordT[tlv.TlvType12, MilliLoki]

	// HtlcMaximumMsat is the maximum HTLC value which will be accepted.
	HTLCMaximumMsat tlv.RecordT[tlv.TlvType14, MilliLoki]
...
func (c *ChannelUpdate2) ForwardingPolicy() *ForwardingPolicy {
	return &ForwardingPolicy{
		...
		BaseFee:       MilliLoki(c.FeeBaseMsat.Val),
		FeeRate:       MilliLoki(c.FeeProportionalMillionths.Val),
