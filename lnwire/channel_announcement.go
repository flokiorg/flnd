...
type ChannelAnnouncement1 struct {
	...
	FlokicoinKey1 [33]byte
	FlokicoinKey2 [33]byte
...
func (a *ChannelAnnouncement1) Encode(w *bytes.Buffer, pver uint32) error {
	...
	if err := WriteSig(w, a.FlokicoinSig1); err != nil {
		return err
	}

	if err := WriteSig(w, a.FlokicoinSig2); err != nil {
		return err
	}
	...
	if err := WriteBytes(w, a.FlokicoinKey1[:]); err != nil {
		return err
	}

	if err := WriteBytes(w, a.FlokicoinKey2[:]); err != nil {
		return err
	}
...
func (a *ChannelAnnouncement1) DataToSign() ([]byte, error) {
	...
	if err := WriteBytes(buf, a.FlokicoinKey1[:]); err != nil {
		return nil, err
	}

	if err := WriteBytes(buf, a.FlokicoinKey2[:]); err != nil {
		return nil, err
	}
