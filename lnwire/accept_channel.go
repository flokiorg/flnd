...
func (a *AcceptChannel) Encode(w *bytes.Buffer, pver uint32) error {
	...
	if err := WriteLoki(w, a.DustLimit); err != nil {
		return err
	}

	if err := WriteMilliLoki(w, a.MaxValueInFlight); err != nil {
		return err
	}

	if err := WriteLoki(w, a.ChannelReserve); err != nil {
		return err
	}

	if err := WriteMilliLoki(w, a.HtlcMinimum); err != nil {
		return err
	}
