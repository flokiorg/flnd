...
func NewInterceptorChain(log flog.Logger, noMacaroons bool,
...
func logRecoveredPanic(logger flog.Logger, fullMethod string,
	panicValue any) {
...
func panicRecoveryUnaryServerInterceptor(
	logger flog.Logger) grpc.UnaryServerInterceptor {
...
func panicRecoveryStreamServerInterceptor(
	logger flog.Logger) grpc.StreamServerInterceptor {
...
// request.
func errorLogUnaryServerInterceptor(logger flog.Logger) grpc.UnaryServerInterceptor {
...
// RPC.
func errorLogStreamServerInterceptor(logger flog.Logger) grpc.StreamServerInterceptor {
